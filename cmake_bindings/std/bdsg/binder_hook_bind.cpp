...
void bind_std_bdsg_binder_hook_bind(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// std::vector file:bdsg/binder_hook_bind.hpp line:28
	...
	// std::vector file:bdsg/binder_hook_bind.hpp line:29
