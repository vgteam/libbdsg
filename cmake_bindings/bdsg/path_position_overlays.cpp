...
// bdsg::PositionOverlay file:bdsg/path_position_overlays.hpp line:30
...
// bdsg::MutablePositionOverlay file:bdsg/path_position_overlays.hpp line:248
struct PyCallBack_bdsg_MutablePositionOverlay : public bdsg::MutablePositionOverlay {
	...
	using _binder_ret_2 = class std::vector<struct handlegraph::step_handle_t, class std::allocator<struct handlegraph::step_handle_t> >;
	_binder_ret_2 steps_of_handle(const struct handlegraph::handle_t & a0, bool a1) const override { 
		pybind11::gil_scoped_acquire gil;
