...
void bind_bdsg_path_position_overlays(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bdsg::PositionOverlay file:bdsg/path_position_overlays.hpp line:30
		...
		cl.def("has_node", (bool (bdsg::PositionOverlay::*)(long) const) &bdsg::PositionOverlay::has_node, "Method to check if a node exists by ID\n\nC++: bdsg::PositionOverlay::has_node(long) const --> bool", pybind11::arg("node_id"));
		cl.def("get_handle", [](bdsg::PositionOverlay const &o, const long & a0) -> handlegraph::handle_t { return o.get_handle(a0); }, "", pybind11::arg("node_id"));
		cl.def("get_handle", (struct handlegraph::handle_t (bdsg::PositionOverlay::*)(const long &, bool) const) &bdsg::PositionOverlay::get_handle, "Look up the handle for the node with the given ID in the given orientation\n\nC++: bdsg::PositionOverlay::get_handle(const long &, bool) const --> struct handlegraph::handle_t", pybind11::arg("node_id"), pybind11::arg("is_reverse"));
		cl.def("get_id", (long (bdsg::PositionOverlay::*)(const struct handlegraph::handle_t &) const) &bdsg::PositionOverlay::get_id, "Get the ID from a handle\n\nC++: bdsg::PositionOverlay::get_id(const struct handlegraph::handle_t &) const --> long", pybind11::arg("handle"));
		...
		cl.def("min_node_id", (long (bdsg::PositionOverlay::*)() const) &bdsg::PositionOverlay::min_node_id, "Return the smallest ID in the graph, or some smaller number if the\n smallest ID is unavailable. Return value is unspecified if the graph is empty.\n\nC++: bdsg::PositionOverlay::min_node_id() const --> long");
		cl.def("max_node_id", (long (bdsg::PositionOverlay::*)() const) &bdsg::PositionOverlay::max_node_id, "Return the largest ID in the graph, or some larger number if the\n largest ID is unavailable. Return value is unspecified if the graph is empty.\n\nC++: bdsg::PositionOverlay::max_node_id() const --> long");
	...
	{ // bdsg::MutablePositionOverlay file:bdsg/path_position_overlays.hpp line:248
		...
		cl.def("create_handle", (struct handlegraph::handle_t (bdsg::MutablePositionOverlay::*)(const std::string &, const long &)) &bdsg::MutablePositionOverlay::create_handle, "Create a new node with the given id and sequence, then return the handle.\n\nC++: bdsg::MutablePositionOverlay::create_handle(const std::string &, const long &) --> struct handlegraph::handle_t", pybind11::arg("sequence"), pybind11::arg("id"));
