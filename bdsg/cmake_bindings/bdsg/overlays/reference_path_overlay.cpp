...
struct PyCallBack_bdsg_ReferencePathOverlay : public bdsg::ReferencePathOverlay {
	...
	bool for_each_path_matching_impl(const class std::unordered_set<enum handlegraph::PathSense> * a0, const class std::unordered_set<std::string > * a1, const class std::unordered_set<std::string > * a2, const class std::function<bool (const struct handlegraph::path_handle_t &)> & a3) const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ReferencePathOverlay *>(this), "for_each_path_matching_impl");
		if (overload) {
...
void bind_bdsg_overlays_reference_path_overlay(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bdsg::ReferencePathOverlay file:bdsg/overlays/reference_path_overlay.hpp line:41
		...
		cl.def( pybind11::init( [](const class handlegraph::PathHandleGraph * a0){ return new bdsg::ReferencePathOverlay(a0); }, [](const class handlegraph::PathHandleGraph * a0){ return new PyCallBack_bdsg_ReferencePathOverlay(a0); } ), "doc");
		cl.def( pybind11::init<const class handlegraph::PathHandleGraph *, const class std::unordered_set<std::string > &>(), pybind11::arg("graph"), pybind11::arg("extra_path_names") );
