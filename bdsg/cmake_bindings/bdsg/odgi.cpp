...
struct PyCallBack_bdsg_ODGI : public bdsg::ODGI {
	...
	enum handlegraph::PathMetadata::Sense get_sense(const struct handlegraph::path_handle_t & a0) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "get_sense");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
	...
	std::string get_sample_name(const struct handlegraph::path_handle_t & a0) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "get_sample_name");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<std::string>::value) {
				static pybind11::detail::overload_caster_t<std::string> caster;
	...
	std::string get_locus_name(const struct handlegraph::path_handle_t & a0) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "get_locus_name");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<std::string>::value) {
				static pybind11::detail::overload_caster_t<std::string> caster;
	...
	long get_haplotype(const struct handlegraph::path_handle_t & a0) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "get_haplotype");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
	...
	long get_phase_block(const struct handlegraph::path_handle_t & a0) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "get_phase_block");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<long>::value) {
				static pybind11::detail::overload_caster_t<long> caster;
	...
	using _binder_ret_1 = struct std::pair<long, long>;
	_binder_ret_1 get_subrange(const struct handlegraph::path_handle_t & a0) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "get_subrange");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
	...
	bool for_each_path_matching_impl(const class std::unordered_set<enum handlegraph::PathMetadata::Sense, struct std::hash<enum handlegraph::PathMetadata::Sense>, struct std::equal_to<enum handlegraph::PathMetadata::Sense>, class std::allocator<enum handlegraph::PathMetadata::Sense> > * a0, const class std::unordered_set<std::string, struct std::hash<std::string>, struct std::equal_to<std::string >, class std::allocator<std::string > > * a1, const class std::unordered_set<std::string, struct std::hash<std::string>, struct std::equal_to<std::string >, class std::allocator<std::string > > * a2, const class std::function<bool (const struct handlegraph::path_handle_t &)> & a3) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "for_each_path_matching_impl");
		if (overload) {
	...
	bool for_each_step_of_sense_impl(const struct handlegraph::handle_t & a0, const enum handlegraph::PathMetadata::Sense & a1, const class std::function<bool (const struct handlegraph::step_handle_t &)> & a2) const override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "for_each_step_of_sense_impl");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1, a2);
			if (pybind11::detail::cast_is_temporary_value_reference<bool>::value) {
				static pybind11::detail::overload_caster_t<bool> caster;
	...
	struct handlegraph::path_handle_t create_path(const enum handlegraph::PathMetadata::Sense & a0, const std::string & a1, const std::string & a2, const long & a3, const long & a4, const struct std::pair<long, long> & a5, bool a6) override { 
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const bdsg::ODGI *>(this), "create_path");
		if (overload) {
...
void bind_bdsg_odgi(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bdsg::ODGI file:bdsg/odgi.hpp line:51
		...
		cl.def("has_next_step", (bool (bdsg::ODGI::*)(const struct handlegraph::step_handle_t &) const) &bdsg::ODGI::has_next_step, "Returns true if the step has a next step on the path, else false\n\nC++: bdsg::ODGI::has_next_step(const struct handlegraph::step_handle_t &) const --> bool", pybind11::arg("step_handle"));
		cl.def("has_previous_step", (bool (bdsg::ODGI::*)(const struct handlegraph::step_handle_t &) const) &bdsg::ODGI::has_previous_step, "Returns true if the step has a previous step on the path, else false\n\nC++: bdsg::ODGI::has_previous_step(const struct handlegraph::step_handle_t &) const --> bool", pybind11::arg("step_handle"));
		...
		cl.def("get_path_handle_of_step", (struct handlegraph::path_handle_t (bdsg::ODGI::*)(const struct handlegraph::step_handle_t &) const) &bdsg::ODGI::get_path_handle_of_step, "Returns a handle to the path that a step is on\n\nC++: bdsg::ODGI::get_path_handle_of_step(const struct handlegraph::step_handle_t &) const --> struct handlegraph::path_handle_t", pybind11::arg("step_handle"));
		...
		cl.def("to_gfa", (void (bdsg::ODGI::*)(const std::string &) const) &bdsg::ODGI::to_gfa, "Convert to GFA and send to the given filename, or \"-\" for standard output (the default).\n\nC++: bdsg::ODGI::to_gfa(const std::string &) const --> void", pybind11::arg("filename"));
		cl.def("to_gfa", (std::string (bdsg::ODGI::*)() const) &bdsg::ODGI::to_gfa, "Convert to GFA and return as a string.\n\nC++: bdsg::ODGI::to_gfa() const --> std::string");
