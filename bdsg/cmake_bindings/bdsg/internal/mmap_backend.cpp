...
void bind_bdsg_internal_mmap_backend(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bdsg::MmapBackend file:bdsg/internal/mmap_backend.hpp line:21
		...
		cl.def("serialize", [](bdsg::MmapBackend &o, const class std::__cxx11::basic_string<char> & a0) -> void { return o.serialize(a0); }, "", pybind11::arg("filename"));
		cl.def("deserialize", [](bdsg::MmapBackend &o, const class std::__cxx11::basic_string<char> & a0) -> void { return o.deserialize(a0); }, "", pybind11::arg("filename"));
