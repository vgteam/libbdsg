...
{
	{ // bdsg::yomo::Manager file:bdsg/internal/mapped_structs.hpp line:180
		...
		cl.def_static("dump", (void (*)(long)) &bdsg::yomo::Manager::dump, "Dump information about free and allocated memory in the gievn chain.\n Not thread safe!\n\nC++: bdsg::yomo::Manager::dump(long) --> void", pybind11::arg("chain"));
