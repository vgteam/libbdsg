...
void bind_bdsg_packed_graph(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // bdsg::MappedPackedGraph file:bdsg/packed_graph.hpp line:49
		pybind11::class_<bdsg::MappedPackedGraph, std::shared_ptr<bdsg::MappedPackedGraph>, bdsg::GraphProxy<bdsg::BasePackedGraph<bdsg::MappedBackend>>, handlegraph::TriviallySerializable> cl(M("bdsg"), "MappedPackedGraph", "");
		cl.def("serialize", [](bdsg::MappedPackedGraph &o, const std::string & a0) -> void { return o.serialize(a0); }, "", pybind11::arg("filename"));
		cl.def("serialize", [](bdsg::MappedPackedGraph const &o, const class std::function<void (const void *, unsigned long)> & a0) -> void { return o.serialize(a0); }, "", pybind11::arg("iteratee"));
