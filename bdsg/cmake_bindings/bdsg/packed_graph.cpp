...
void bind_bdsg_packed_graph(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // bdsg::MappedPackedGraph file:bdsg/packed_graph.hpp line:49
		...
		cl.def("serialize", (void (bdsg::MappedPackedGraph::*)(const class std::function<void (const void *, unsigned long)> &) const) &bdsg::MappedPackedGraph::serialize, "Serialize us as a series of in-memory blocks shown to the given function.\n Backs const serialization to FDs, and serialization to streams.\n\nC++: bdsg::MappedPackedGraph::serialize(const class std::function<void (const void *, unsigned long)> &) const --> void", pybind11::arg("iteratee"));
