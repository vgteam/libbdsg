...
void bind_bdsg_snarl_distance_index(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bdsg::SnarlDistanceIndex file:bdsg/snarl_distance_index.hpp line:181
		...
		cl.def("net_has_distances", (bool (bdsg::SnarlDistanceIndex::*)(const struct handlegraph::net_handle_t &) const) &bdsg::SnarlDistanceIndex::net_has_distances, "Does this net handle store distances?\n\nC++: bdsg::SnarlDistanceIndex::net_has_distances(const struct handlegraph::net_handle_t &) const --> bool", pybind11::arg("net"));
		cl.def("graph_has_distances", (bool (bdsg::SnarlDistanceIndex::*)() const) &bdsg::SnarlDistanceIndex::graph_has_distances, "Does the distance index in general store distances?\n\nC++: bdsg::SnarlDistanceIndex::graph_has_distances() const --> bool");
		...
		{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex file:bdsg/snarl_distance_index.hpp line:1529
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporaryRecord file:bdsg/snarl_distance_index.hpp line:1549
				auto & enclosing_class = cl;
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporaryChainRecord file:bdsg/snarl_distance_index.hpp line:1551
				auto & enclosing_class = cl;
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporarySnarlRecord file:bdsg/snarl_distance_index.hpp line:1593
				auto & enclosing_class = cl;
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporaryNodeRecord file:bdsg/snarl_distance_index.hpp line:1626
				auto & enclosing_class = cl;
