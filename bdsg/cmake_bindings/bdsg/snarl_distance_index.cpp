...
void bind_bdsg_snarl_distance_index(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // bdsg::SnarlDistanceIndex file:bdsg/snarl_distance_index.hpp line:96
		...
		{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex file:bdsg/snarl_distance_index.hpp line:1203
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporaryRecord file:bdsg/snarl_distance_index.hpp line:1221
				auto & enclosing_class = cl;
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporaryChainRecord file:bdsg/snarl_distance_index.hpp line:1223
				auto & enclosing_class = cl;
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporarySnarlRecord file:bdsg/snarl_distance_index.hpp line:1250
				auto & enclosing_class = cl;
			...
			{ // bdsg::SnarlDistanceIndex::TemporaryDistanceIndex::TemporaryNodeRecord file:bdsg/snarl_distance_index.hpp line:1276
				auto & enclosing_class = cl;
		...
		cl.def("load", (void (bdsg::SnarlDistanceIndex::*)(const std::string &)) &bdsg::SnarlDistanceIndex::load, "C++: bdsg::SnarlDistanceIndex::load(const std::string &) --> void", pybind11::arg("filename"));
		...
		cl.def("save", (void (bdsg::SnarlDistanceIndex::*)(const std::string &) const) &bdsg::SnarlDistanceIndex::save, "C++: bdsg::SnarlDistanceIndex::save(const std::string &) const --> void", pybind11::arg("filename"));
