...
void bind_handlegraph_trivially_serializable(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // handlegraph::TriviallySerializable file:handlegraph/trivially_serializable.hpp line:31
		...
		cl.def("serialize", (void (handlegraph::TriviallySerializable::*)(const class std::function<void (const void *, unsigned long)> &) const) &handlegraph::TriviallySerializable::serialize, "C++: handlegraph::TriviallySerializable::serialize(const class std::function<void (const void *, unsigned long)> &) const --> void", pybind11::arg("iteratee"));
