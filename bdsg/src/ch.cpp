...
/** Writes labels into two std::vector<vector<HubRecord>
 * Only used inside test_libbdsg.cpp
 */
void create_labels_test(vector<vector<HubRecord>>& labels, vector<vector<HubRecord>>& labels_back, CHOverlay& ov) { 
#ifdef debug_create
