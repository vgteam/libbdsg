...
bool SnarlDistanceIndex::is_root_snarl(const net_handle_t& net) const {
    ...
    if (get_handle_type(net) == ROOT_HANDLE && get_record_offset(net) != 0) {
        assert(SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == ROOT_SNARL ||
               SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == DISTANCED_ROOT_SNARL);
    }
#endif
...
if(get_handle_type(net) == SNARL_HANDLE){
    assert(SnarlTreeRecord::get_record_handle_type(get_record_offset(net), &snarl_tree_records) == SNARL_HANDLE ||
        SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == ROOT_SNARL ||
        SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == DISTANCED_ROOT_SNARL);
...
if (get_handle_type(net) ==CHAIN_HANDLE) {
    assert(SnarlTreeRecord::get_record_handle_type(get_record_offset(net), &snarl_tree_records) == CHAIN_HANDLE ||
           SnarlTreeRecord::get_record_handle_type(get_record_offset(net), &snarl_tree_records) == NODE_HANDLE ||
           SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == SIMPLE_SNARL ||
           SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == DISTANCED_SIMPLE_SNARL);
}
#endif
...
#endif
    return get_handle_type(net) == CHAIN_HANDLE 
        && SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == MULTICOMPONENT_CHAIN;
}
bool SnarlDistanceIndex::is_looping_chain(const net_handle_t& net) const {
    if (!is_chain(net)) {
        return false;
    }
    return ChainRecord::get_start_id(get_record_offset(net), &snarl_tree_records) == 
           ChainRecord::get_end_id(get_record_offset(net), &snarl_tree_records);
}
...
bool SnarlDistanceIndex::is_trivial_chain(const net_handle_t& net) const {
    ...
    net_handle_record_t record_handle_type =SnarlTreeRecord::get_record_handle_type(get_record_offset(net), &snarl_tree_records); 
    record_t record_type =SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records); 
    bool record_is_node = record_handle_type == NODE_HANDLE;
    bool record_is_simple_snarl = record_type == SIMPLE_SNARL ||
                                  record_type == DISTANCED_SIMPLE_SNARL ;
...
if(get_handle_type(net) == NODE_HANDLE){
    assert( SnarlTreeRecord::get_record_handle_type(get_record_offset(net), &snarl_tree_records) == NODE_HANDLE 
         || SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == SIMPLE_SNARL
         || SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == DISTANCED_SIMPLE_SNARL );
}
#endif
...
handle_t SnarlDistanceIndex::get_handle(const net_handle_t& net, const handlegraph::HandleGraph* graph) const{
    if (get_handle_type(net) == SENTINEL_HANDLE) {
        size_t record_offset = get_record_offset(net);
        if (starts_at(net) == START) {
            return graph->get_handle(SnarlRecord::get_start_id(record_offset, &snarl_tree_records), 
                       ends_at(net) == START ? !SnarlRecord::get_start_orientation(record_offset, &snarl_tree_records)   //Going out
                                             : SnarlRecord::get_start_orientation(record_offset, &snarl_tree_records));  //Going in
        } else {
            assert (starts_at(net) == END);
            return graph->get_handle(SnarlRecord::get_end_id(record_offset, &snarl_tree_records), 
                       ends_at(net) == END ? SnarlRecord::get_end_orientation(record_offset, &snarl_tree_records)   //Going out
                                           : !SnarlRecord::get_end_orientation(record_offset, &snarl_tree_records));  //Going in
        }
...
net_handle_t SnarlDistanceIndex::get_parent(const net_handle_t& child) const {
#ifdef debug_distances
    cerr << "get parent of " << net_handle_as_string(child) << endl;
#endif
    ...
    size_t parent_pointer = SnarlTreeRecord::get_parent_record_offset(get_record_offset(child), &snarl_tree_records);
    net_handle_record_t parent_type = SnarlTreeRecord::get_record_handle_type(parent_pointer, &snarl_tree_records);
...
net_handle_t SnarlDistanceIndex::get_bound(const net_handle_t& snarl, bool get_end, bool face_in) const {
    if (get_handle_type(snarl) == CHAIN_HANDLE) {
        ...
        if (is_trivial_chain(snarl)) {
            ...
            if (get_end) {
                tuple<size_t, bool, size_t> last_child = ChainRecord::get_last_child_offset(get_record_offset(snarl), &snarl_tree_records);
                is_looping_chain = ChainRecord::get_start_id(get_record_offset(snarl), &snarl_tree_records) == ChainRecord::get_end_id(get_record_offset(snarl), &snarl_tree_records);
                offset = is_looping_chain ? ChainRecord::get_first_node_offset(get_record_offset(snarl), &snarl_tree_records) : std::get<0>(last_child);
                node_offset = is_looping_chain ? 0 : std::get<2>(last_child); 

            } else {
                offset = ChainRecord::get_first_node_offset(get_record_offset(snarl), &snarl_tree_records); 
                node_offset = 0;
                
            }
            rev_in_parent = TrivialSnarlRecord::get_is_reversed_in_parent(offset, &snarl_tree_records, node_offset);
        }
        if (get_end) {
...
net_handle_t SnarlDistanceIndex::get_node_from_sentinel(const net_handle_t& sentinel) const {
    ...
    size_t parent_chain_offset = get_record_offset(parent_chain); 

    net_handle_t next_handle = ChainRecord::get_next_child(parent_chain_offset, &snarl_tree_records, snarl, starts_at(sentinel) == START);
...
net_handle_t SnarlDistanceIndex::canonical(const net_handle_t& net) const {
    size_t record_offset = get_record_offset(net);
    record_t type = SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records);
    ...
    if (SnarlTreeRecord::is_start_end_connected(record_offset, &snarl_tree_records)) {
        connectivity = START_END;
    } else if (SnarlTreeRecord::is_start_tip_connected(record_offset, &snarl_tree_records)) {
        connectivity = START_TIP;
    } else if (SnarlTreeRecord::is_end_tip_connected(record_offset, &snarl_tree_records)) {
        connectivity = END_TIP;
    } else if (SnarlTreeRecord::is_start_start_connected(record_offset, &snarl_tree_records)) {
        connectivity = START_START;
    } else if (SnarlTreeRecord::is_end_end_connected(record_offset, &snarl_tree_records)) {
        connectivity = END_END;
    } else if (SnarlTreeRecord::is_tip_tip_connected(record_offset, &snarl_tree_records)) {
        connectivity = TIP_TIP;
    } else {
        connectivity = START_END; 
    }
    return get_net_handle_from_values(record_offset, connectivity, get_handle_type(net), get_node_record_offset(net));
}
...
size_t SnarlDistanceIndex::get_rank_in_parent(const net_handle_t& net) const {
    ...
    if (get_record_type(tag) == TRIVIAL_SNARL ||
        ...
        return TrivialSnarlRecord::get_rank_in_parent(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
        ...
        return SnarlTreeRecord::get_rank_in_parent(get_record_offset(net), &snarl_tree_records);
    }
}

size_t SnarlDistanceIndex::connected_component_count() const {
    return RootRecord::get_connected_component_count(get_record_offset(get_root()), &snarl_tree_records);
}
...
bool SnarlDistanceIndex::for_each_child_impl(const net_handle_t& traversal, const std::function<bool(const net_handle_t&)>& iteratee) const {
    ...
    net_handle_record_t record_type = SnarlTreeRecord::get_record_handle_type(get_record_offset(traversal), &snarl_tree_records);
    ...
    if (SnarlTreeRecord::get_record_type(get_record_offset(traversal), &snarl_tree_records) == SIMPLE_SNARL ||
        SnarlTreeRecord::get_record_type(get_record_offset(traversal), &snarl_tree_records) == DISTANCED_SIMPLE_SNARL ) {
        ...
        if (handle_type == CHAIN_HANDLE) {
            ...
            return SimpleSnarlRecord::for_each_child(get_record_offset(traversal), &snarl_tree_records, iteratee);
        ...
        return SnarlRecord::for_each_child(get_record_offset(traversal), &snarl_tree_records, iteratee);
    } else if (record_type == CHAIN_HANDLE) {
        return ChainRecord::for_each_child(get_record_offset(traversal), &snarl_tree_records, iteratee);
    } else if (record_type == ROOT_HANDLE) {
        return RootRecord::for_each_child(get_record_offset(traversal), &snarl_tree_records, iteratee);
...
bool SnarlDistanceIndex::for_each_traversal_impl(const net_handle_t& item, const std::function<bool(const net_handle_t&)>& iteratee) const {
    ...
    for ( size_t type = 1 ; type <= 9 ; type ++ ){
        ...
        if (SnarlTreeRecord::has_connectivity(get_record_offset(item), &snarl_tree_records, connectivity)) {
...
bool SnarlDistanceIndex::follow_net_edges_impl(const net_handle_t& here, const handlegraph::HandleGraph* graph, bool go_left, const std::function<bool(const net_handle_t&)>& iteratee) const {
    ...
    size_t parent_record_offset = get_record_offset(get_parent(here));
    net_handle_record_t parent_record_handle_type = SnarlTreeRecord::get_record_handle_type(parent_record_offset, &snarl_tree_records);
    record_t parent_record_type = SnarlTreeRecord::get_record_type(parent_record_offset, &snarl_tree_records);


    if (parent_record_handle_type == ROOT_HANDLE &&
        parent_record_type != ROOT_SNARL &&
        parent_record_type != DISTANCED_ROOT_SNARL) {
#ifdef debug_snarl_traversal
        ...
        if ((go_left && starts_at(here) == END) || (!go_left && ends_at(here) == END)) {
            ...
            if (SnarlTreeRecord::is_externally_start_end_connected(get_record_offset(here), &snarl_tree_records)) {
            ...
            if (SnarlTreeRecord::is_externally_end_end_connected(get_record_offset(here), &snarl_tree_records)) {
        ...
        assert(parent_record_handle_type == SNARL_HANDLE ||
               parent_record_handle_type == ROOT_HANDLE);
        ...
        bool is_root_snarl = parent_record_type == ROOT_SNARL
                           || parent_record_type == DISTANCED_ROOT_SNARL;
        ...
        if (get_handle_type(here) == SENTINEL_HANDLE) {
            if ((get_connectivity(here) == START_END && !go_left) ||
                ...
                graph_handle = graph->get_handle(SnarlTreeRecord::get_start_id(parent_record_offset, &snarl_tree_records), 
                                                 SnarlTreeRecord::get_start_orientation(parent_record_offset, &snarl_tree_records));
                ...
                graph_handle = graph->get_handle(SnarlTreeRecord::get_end_id(parent_record_offset, &snarl_tree_records), 
                                                 !SnarlTreeRecord::get_end_orientation(parent_record_offset, &snarl_tree_records));
            } else {
        ...
        graph->follow_edges(graph_handle, false, [&](const handle_t& h) {
            ...
            if (!is_root_snarl && graph->get_id(h) == SnarlTreeRecord::get_start_id(parent_record_offset, &snarl_tree_records)) {
                //If this is the start boundary node of the parent snarl, then do this on the sentinel
#ifdef debug_snarl_traversal
                cerr << "    -> start of parent " << endl;
                assert(graph->get_is_reverse(h) == !SnarlTreeRecord::get_start_orientation(parent_record_offset, &snarl_tree_records));
#endif
                return iteratee(get_bound(get_parent(here), false, false));
            } else if (!is_root_snarl && graph->get_id(h) == SnarlTreeRecord::get_end_id(parent_record_offset, &snarl_tree_records)) {
#ifdef debug_snarl_traversal
                assert(graph->get_is_reverse(h) == SnarlTreeRecord::get_end_orientation(parent_record_offset, &snarl_tree_records));
                ...
                cerr << "    -> actual child node " << net_handle_as_string(next_net) << endl;
                   ...
                   return iteratee(next_net);
                    ...
                    net_handle_t next_net = get_net_handle_from_values(get_record_offset(get_parent(node_net_handle)), 
                                                           ...
                                                           CHAIN_HANDLE);
#ifdef debug_snarl_traversal
                    assert(SnarlTreeRecord::.get_record_handle_type(get_record_offset(get_parent(node_net_handle)), &snarl_tree_records) == CHAIN_HANDLE);
        ...
        assert(parent_record_handle_type == CHAIN_HANDLE);
#endif
        if (get_record_offset(here) == parent_record_offset) {
        ...
        bool is_rev = is_node(here) ? TrivialSnarlRecord::get_is_reversed_in_parent(
                                        get_record_offset(here), &snarl_tree_records,get_node_record_offset(here))
                                    : false;
        if (is_rev) {
            go_left_in_chain = !go_left_in_chain;
        }
        net_handle_t next_net = ChainRecord::get_next_child(parent_record_offset, &snarl_tree_records, 
                                                            here, go_left_in_chain);
        if (next_net == here ) {
...
net_handle_t SnarlDistanceIndex::get_parent_traversal(const net_handle_t& traversal_start, const net_handle_t& traversal_end) const {
    ...
    if (start_handle_type == SENTINEL_HANDLE) {
        ...
        size_t parent_record_offset = SnarlTreeRecord::get_parent_record_offset(get_record_offset(traversal_start), &snarl_tree_records);
#ifdef debug_snarl_traversal
        if (parent_record_offset != SnarlTreeRecord::get_parent_record_offset(get_record_offset(traversal_end), &snarl_tree_reacords)) {
            throw runtime_error("error: Looking for parent traversal of two non-siblings");
        }
#endif
#ifdef debug_snarl_traversal
        assert(SnarlTreeRecord::get_record_handle_type(parent_record_offset, &snarl_tree_records) == CHAIN_HANDLE);
#endif

        //Figure out what the start and end of the traversal are
        endpoint_t start_endpoint;
        if (start_handle_type == NODE_HANDLE && 
            node_id(traversal_start) == SnarlTreeRecord::get_start_id(parent_record_offset, &snarl_tree_records) &&
            (get_start_endpoint(traversal_start) == START && !SnarlTreeRecord::get_start_orientation(parent_record_offset, &snarl_tree_records) ||
             get_start_endpoint(traversal_start) == END && SnarlTreeRecord::get_start_orientation(parent_record_offset, &snarl_tree_records)) ){
            ...
            node_id(traversal_start) == SnarlTreeRecord::get_end_id(parent_record_offset, &snarl_tree_records) &&
            (get_start_endpoint(traversal_start) == START && SnarlTreeRecord::get_end_orientation(parent_record_offset, &snarl_tree_records) ||
             get_start_endpoint(traversal_start) == END && !SnarlTreeRecord::get_end_orientation(parent_record_offset, &snarl_tree_records)) ){
        ...
        if (end_handle_type == NODE_HANDLE && 
            node_id(traversal_end) == SnarlTreeRecord::get_start_id(parent_record_offset, &snarl_tree_records) &&
            (get_start_endpoint(traversal_end) == START && SnarlTreeRecord::get_start_orientation(parent_record_offset, &snarl_tree_records) ||
             get_start_endpoint(traversal_end) == END && !SnarlTreeRecord::get_start_orientation(parent_record_offset, &snarl_tree_records))){
            //If traversal_end is a node and also the start node oriented out of the parent
            end_endpoint = START;
        } else if (end_handle_type == NODE_HANDLE && 
            node_id(traversal_end) == SnarlTreeRecord::get_end_id(parent_record_offset, &snarl_tree_records) &&
            (get_start_endpoint(traversal_end) == START && !SnarlTreeRecord::get_end_orientation(parent_record_offset, &snarl_tree_records) ||
             get_start_endpoint(traversal_end) == END && SnarlTreeRecord::get_end_orientation(parent_record_offset, &snarl_tree_records)) ){
        ...
        if (!SnarlTreeRecord::has_connectivity(parent_record_offset, &snarl_tree_records, start_endpoint, end_endpoint)) {
            throw runtime_error("error: Trying to get parent traversal that is not connected");
        }
#endif

        return get_net_handle_from_values(parent_record_offset, 
                              endpoints_to_connectivity(start_endpoint, end_endpoint), 
                              CHAIN_HANDLE);
    }
...
size_t SnarlDistanceIndex::distance_in_parent(const net_handle_t& parent, 
    ...
    if (is_root(parent)) {
        ...
        if (parent_record_offset1 != parent_record_offset2) {
            ...
            return SnarlRecord::get_distance(parent_record_offset1, &snarl_tree_records,
                                             get_rank_in_parent(child1), !child_ends_at_start1, 
        ...
        for (size_t i = 0 ; i <=1 ; i ++ ) {
            ...
            if (is_node(child)) {
                ...
                std::tie(prefix_sum, forward_loop, reverse_loop, component) = 
                    TrivialSnarlRecord::get_chain_values(get_record_offset(child), &snarl_tree_records,
                                                          get_node_record_offset(child));
                end_component = TrivialSnarlRecord::get_chain_component(get_record_offset(child), 
                                    &snarl_tree_records, get_node_record_offset(child), true);
                ...
                if (child_ends_at_start) {
                    ...
                    std::tie(prefix_sum, forward_loop, reverse_loop, component) = 
                        TrivialSnarlRecord::get_chain_values(get_record_offset(start_bound), &snarl_tree_records,
                                                             get_node_record_offset(start_bound));
                    ...
                    std::tie(prefix_sum, forward_loop, reverse_loop, component) =
                            TrivialSnarlRecord::get_chain_values(get_record_offset(end_bound), &snarl_tree_records,
                                                                 get_node_record_offset(end_bound));
        ...
        return sum({ChainRecord::get_distance(get_record_offset(parent), &snarl_tree_records,
                                              rank_in_chain1, go_left1,
        ...
        if (get_record_type(snarl_tree_records->at(get_record_offset(parent))) == DISTANCED_SIMPLE_SNARL) {
            return SimpleSnarlRecord::get_distance(get_record_offset(parent), &snarl_tree_records, 
                                                   rank1, rev1, rank2, rev2);
            ...
            return SnarlRecord::get_distance_start_start(get_record_offset(parent), &snarl_tree_records);
        } else if ((rank1 == 0 && rank2 == 1) || (rank1 == 1 && rank2 == 0) && !snarl_is_root) {
            //start to end / end to start is stored in the snarl
            return SnarlRecord::get_min_length(get_record_offset(parent), &snarl_tree_records);
        } else if (rank1 == 1 && rank2 == 1 && !snarl_is_root) {
            //end to end is stored in the snarl
            return SnarlRecord::get_distance_end_end(get_record_offset(parent), &snarl_tree_records);
            ...
            net_handle_t internal_child = (rank1 == 0 || rank1 == 1) ? child2 : child1;
            size_t internal_child_offset = get_record_offset(internal_child);
            ...
            if (is_trivial_chain( internal_child) ) {
                ...
                if (boundary_rank == 0 && !internal_is_reversed) {
                    ...
                    return NodeRecord::get_distance_left_start(internal_child_offset, &snarl_tree_records);
                } else if (boundary_rank == 0 && internal_is_reversed) {
                    //Start to right of child
                    return NodeRecord::get_distance_right_start(internal_child_offset, &snarl_tree_records);
                } else if (boundary_rank == 1 && !internal_is_reversed) {
                    //End to left of child
                    return NodeRecord::get_distance_left_end(internal_child_offset, &snarl_tree_records);
                } else {
                    //End to right of child
                    return NodeRecord::get_distance_right_end(internal_child_offset, &snarl_tree_records);
                }
            } else {
                //Child is an actual chain
                if (boundary_rank == 0 && !internal_is_reversed) {
                    //Start to left of child
                    return ChainRecord::get_distance_left_start(internal_child_offset, &snarl_tree_records);
                } else if (boundary_rank == 0 && internal_is_reversed) {
                    //Start to right of child
                    return ChainRecord::get_distance_right_start(internal_child_offset, &snarl_tree_records);
                } else if (boundary_rank == 1 && !internal_is_reversed) {
                    //End to left of child
                    return ChainRecord::get_distance_left_end(internal_child_offset, &snarl_tree_records);
                } else {
                    //End to right of child
                    return ChainRecord::get_distance_right_end(internal_child_offset, &snarl_tree_records);
                }
            }
        } else {
           return SnarlRecord::get_distance(get_record_offset(parent), &snarl_tree_records, 
                                            rank1, rev1, rank2, rev2);
        }
    } else {
        ...
        for (size_t i = 0 ; i <=1 ; i ++ ) {
            ...
            if (is_node(child)) {
                ...
                std::tie(prefix_sum, forward_loop, reverse_loop, component) = 
                    TrivialSnarlRecord::get_chain_values(get_record_offset(child), &snarl_tree_records,
                                                         get_node_record_offset(child));
                prefix_sum = TrivialSnarlRecord::get_max_prefix_sum(get_record_offset(child), &snarl_tree_records,
                                                                    get_node_record_offset(child));
                end_component = TrivialSnarlRecord::get_chain_component(get_record_offset(child), 
                                                      &snarl_tree_records, get_node_record_offset(child), true);
                ...
                if (child_ends_at_start) {
                    ...
                    prefix_sum = TrivialSnarlRecord::get_max_prefix_sum(get_record_offset(start_bound), 
                                                &snarl_tree_records, get_node_record_offset(start_bound));
                    node_lengths_to_add += start_length;
                } else {
                    //Do the same thing for the snarl end node if we're going forwards
                    net_handle_t end_bound = get_node_from_sentinel(get_bound(child, true, false));
                    ...
                    node_length = end_length;
                    std::tie(prefix_sum, forward_loop, reverse_loop, component) =
                            TrivialSnarlRecord::get_chain_values(get_record_offset(end_bound), 
                                        &snarl_tree_records, get_node_record_offset(end_bound));

                    prefix_sum = TrivialSnarlRecord::get_max_prefix_sum(get_record_offset(end_bound), 
                                        &snarl_tree_records, get_node_record_offset(end_bound));
...
size_t SnarlDistanceIndex::distance_to_parent_bound(const net_handle_t& parent, bool to_start, net_handle_t child,
    ...
    if (parent_is_trivial_chain) {
        ...
        if (is_simple_snarl(parent)) {
            ...
            size_t child_offset = get_record_offset(child);
    
            if (child_is_trivial_chain) {
                if (child_ends_at_start && to_start) {
                    return NodeRecord::get_distance_left_start(child_offset, &snarl_tree_records);
                } else if (!child_ends_at_start && to_start) {
                    return NodeRecord::get_distance_right_start(child_offset, &snarl_tree_records);
                } else if (child_ends_at_start && !to_start) { 
                    return NodeRecord::get_distance_left_end(child_offset, &snarl_tree_records);
                } else {
                    return NodeRecord::get_distance_right_end(child_offset, &snarl_tree_records);
                }
            } else {
                if (child_ends_at_start && to_start) {
                    return ChainRecord::get_distance_left_start(child_offset, &snarl_tree_records);
                } else if (!child_ends_at_start && to_start) {
                    return ChainRecord::get_distance_right_start(child_offset, &snarl_tree_records);
                } else if (child_ends_at_start && !to_start) { 
                    return ChainRecord::get_distance_left_end(child_offset, &snarl_tree_records);
                } else {
                    return ChainRecord::get_distance_right_end(child_offset, &snarl_tree_records);
                }
            }
        }
...
tuple<nid_t, bool, bool> SnarlDistanceIndex::into_which_snarl(const nid_t& id, const bool& reverse) const {
    ...
    if (is_trivial_chain(parent) && is_root(parent)) {
        ...
        net_handle_t next_child = ChainRecord::get_next_child(get_record_offset(parent), &snarl_tree_records, 
                                                              node, go_left_in_chain);
...
pair<net_handle_t, bool> SnarlDistanceIndex::lowest_common_ancestor(const net_handle_t& net1, const net_handle_t& net2) const {
    ...
    if (is_root(parent2) && is_root(parent1)){
        size_t parent_record_offset1 = SnarlTreeRecord::get_parent_record_offset(get_record_offset(parent1), 
                                                                                 &snarl_tree_records);
        size_t parent_record_offset2 = SnarlTreeRecord::get_parent_record_offset(get_record_offset(parent2), 
                                                                                 &snarl_tree_records);
        if (parent_record_offset1 != parent_record_offset2) {
            is_connected = false;
        }
...
size_t SnarlDistanceIndex::minimum_distance(const handlegraph::nid_t id1, const bool rev1, const size_t offset1, 
    ...
    size_t max_node_id = RootRecord::get_min_node_id(get_record_offset(get_root()), &snarl_tree_records) 
                       + RootRecord::get_node_count(get_record_offset(get_root()), &snarl_tree_records);
    if (id1 < RootRecord::get_min_node_id(get_record_offset(get_root()), &snarl_tree_records) 
        || id2 < RootRecord::get_min_node_id(get_record_offset(get_root()), &snarl_tree_records) 
...
void SnarlDistanceIndex::for_each_handle_in_shortest_path_in_snarl(const net_handle_t& snarl_handle, net_handle_t start, net_handle_t end,
    ...
    if (SnarlRecord::get_record_type(get_record_offset(snarl_handle), &snarl_tree_records) != OVERSIZED_SNARL) {
    ...
    while (next != end || !started) {
        ...
        follow_net_edges(next, graph, false, [&] (const net_handle_t& next_net) {
            ...
            bool snarl_is_root = is_root(snarl_handle) || is_root_snarl(snarl_handle) ||
                           SnarlTreeRecord::get_record_type(get_record_offset(snarl_handle), &snarl_tree_records) == ROOT_SNARL ||
                            SnarlTreeRecord::get_record_type(get_record_offset(snarl_handle), &snarl_tree_records) == DISTANCED_ROOT_SNARL;
...
#endif
        net_handle_t next = ChainRecord::get_next_child(get_record_offset(chain_handle), &snarl_tree_records, start, go_left); 
#ifdef debug_distance_paths
...
size_t SnarlDistanceIndex::node_length(const net_handle_t& net) const {
    if (is_node(net)) {
        if (get_record_type(snarl_tree_records->at(get_record_offset(net))) == DISTANCED_NODE) {
            return NodeRecord::get_node_length(get_record_offset(net), &snarl_tree_records);
        } else if (get_record_type(snarl_tree_records->at(get_record_offset(net))) == DISTANCED_SIMPLE_SNARL) {
            return SimpleSnarlRecord::get_node_length(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
        } else {
            assert(get_record_type(snarl_tree_records->at(get_record_offset(net))) == DISTANCED_TRIVIAL_SNARL);
            return TrivialSnarlRecord::get_node_length(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
        }
...
size_t SnarlDistanceIndex::minimum_length(const net_handle_t& net) const {
    size_t record_offset = get_record_offset(net);
    if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == TRIVIAL_SNARL || 
        SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == DISTANCED_TRIVIAL_SNARL) {
        return TrivialSnarlRecord::get_node_length(record_offset, &snarl_tree_records,get_node_record_offset(net));
    } else if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == SIMPLE_SNARL || 
               SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == DISTANCED_SIMPLE_SNARL) {
        if (is_snarl(net)) {
            return SimpleSnarlRecord::get_min_length(record_offset, &snarl_tree_records);
        } else {
            return SimpleSnarlRecord::get_node_length(record_offset, &snarl_tree_records, get_node_record_offset(net));
        }
    } else if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == MULTICOMPONENT_CHAIN) {
        return std::numeric_limits<size_t>::max();
    } else {
        return SnarlTreeRecord::get_min_length(record_offset, &snarl_tree_records);
    }
}
...
size_t SnarlDistanceIndex::chain_minimum_length(const net_handle_t& net) const {
    ...
    if (is_trivial_chain(net)) {
        ...
        return ChainRecord::get_min_length(get_record_offset(net), &snarl_tree_records);
    }
}
size_t SnarlDistanceIndex::maximum_length(const net_handle_t& net) const {
    ...
    if ((SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == TRIVIAL_SNARL || 
        ...
        return TrivialSnarlRecord::get_node_length(record_offset, &snarl_tree_records, get_node_record_offset(net));
               ...
               SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == DISTANCED_SIMPLE_SNARL) {
        if (is_snarl(net)) {
            return SimpleSnarlRecord::get_max_length(record_offset, &snarl_tree_records);
        } else {
            return SimpleSnarlRecord::get_node_length(record_offset, &snarl_tree_records, get_node_record_offset(net));
        }
    } else {
        return SnarlTreeRecord::get_max_length(record_offset, &snarl_tree_records);
    }
}
nid_t SnarlDistanceIndex::node_id(const net_handle_t& net) const {
    if (is_node(net) || is_trivial_chain(net)) {
        if (get_record_type(snarl_tree_records->at(get_record_offset(net))) == NODE 
            ...
            return NodeRecord::get_node_id(get_record_offset(net), &snarl_tree_records);
            ...
            return SimpleSnarlRecord::get_node_id(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
        } else {
            return TrivialSnarlRecord::get_node_id(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
        }
    } else if (is_sentinel(net)) {
        if (get_start_endpoint(net) == START) {
            return SnarlRecord::get_start_id(get_record_offset(net), &snarl_tree_records);
        } else {
            return SnarlRecord::get_end_id(get_record_offset(net), &snarl_tree_records);
        }
    } else {
...
bool SnarlDistanceIndex::has_node(const nid_t id) const {
    size_t node_pointer_offset = get_node_pointer_offset(id, 
                RootRecord::get_min_node_id(get_record_offset(get_root()), &snarl_tree_records), 
                RootRecord::get_connected_component_count(get_record_offset(get_root()), &snarl_tree_records));
...
bool SnarlDistanceIndex::is_reversed_in_parent(const net_handle_t& net) const {
    ...
    if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == TRIVIAL_SNARL 
        ...
        return TrivialSnarlRecord::get_is_reversed_in_parent(record_offset, &snarl_tree_records,
                                                             get_node_record_offset(net));

    } else if ((SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == SIMPLE_SNARL 
                || SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == DISTANCED_SIMPLE_SNARL)
              && is_chain(net)) {

        return SimpleSnarlRecord::get_node_is_reversed(record_offset, &snarl_tree_records, get_node_record_offset(net));
    } else {
        return SnarlTreeRecord::get_is_reversed_in_parent(record_offset, &snarl_tree_records);
    }
}
...
#ifdef debug_distances
    cerr << " Min node id " << RootRecord::get_min_node_id(get_record_offset(get_root()), &snarl_tree_records)
         << " connected component count " << RootRecord::get_connected_component_count(get_record_offset(get_root()), &snarl_tree_records) << endl;
    cerr << "Get node " << id << "-> offset " << record_offset << ", " << node_record_offset << endl;
#endif
...
size_t SnarlDistanceIndex::get_max_tree_depth() const {
    return RootRecord::get_max_tree_depth(get_record_offset(get_root()), &snarl_tree_records);
}

size_t SnarlDistanceIndex::get_depth(const net_handle_t& net) const {
    if (is_root(net)) {
        return 0;
    } else if (SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == SIMPLE_SNARL ||
               SnarlTreeRecord::get_record_type(get_record_offset(net), &snarl_tree_records) == DISTANCED_SIMPLE_SNARL ){
        ...
        return ChainRecord::get_depth(get_record_offset(net), &snarl_tree_records);
    } else {
...
size_t SnarlDistanceIndex::get_connected_component_number(const net_handle_t& net) const {
    ...
    if (get_record_offset(parent) == 0) {
        ...
        return SnarlTreeRecord::get_rank_in_parent(get_record_offset(child), &snarl_tree_records);
    } else {
        //Otherwise, it must be a root-level snarl pretending to be a root
        return SnarlTreeRecord::get_rank_in_parent(get_record_offset(parent), &snarl_tree_records);
    }
}
...
net_handle_t SnarlDistanceIndex::get_handle_from_connected_component(size_t num) const {
    ...
    net_handle_record_t type = SnarlTreeRecord::get_record_handle_type(child_offset, &snarl_tree_records);
    if (type == NODE_HANDLE) {
...
bool SnarlDistanceIndex::has_connectivity(const net_handle_t& net, endpoint_t start, endpoint_t end) const {
    return SnarlTreeRecord::has_connectivity(get_record_offset(net), &snarl_tree_records, start, end);
}

SnarlDistanceIndex::record_t SnarlDistanceIndex::SnarlTreeRecord::get_record_type(const size_t& record_offset, const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return static_cast<record_t>((*records)->at(record_offset) >> 9);
}

SnarlDistanceIndex::net_handle_record_t SnarlDistanceIndex::SnarlTreeRecord::get_record_handle_type(const size_t& record_offset, const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    record_t type = get_record_type(record_offset, records);
...
bool SnarlDistanceIndex::SnarlTreeRecord::is_start_start_connected(const size_t& record_offset,
                                         const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return (*records)->at(record_offset) & 32;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_start_end_connected(const size_t& record_offset,
                                         const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return (*records)->at(record_offset) & 16;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_start_tip_connected(const size_t& record_offset,
                                         const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return (*records)->at(record_offset) & 8;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_end_end_connected(const size_t& record_offset,
                                         const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset) & 4;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_end_tip_connected(const size_t& record_offset,
                                         const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset) & 2;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_tip_tip_connected(const size_t& record_offset, 
                                         const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset) & 1;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_externally_start_end_connected(const size_t& record_offset,
                                          const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return (*records)->at(record_offset) & 64;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_externally_start_start_connected(const size_t& record_offset,
                                          const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return (*records)->at(record_offset) & 128;
}
bool SnarlDistanceIndex::SnarlTreeRecord::is_externally_end_end_connected(const size_t& record_offset,
                                          const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset) & 256;
}

bool SnarlDistanceIndex::SnarlTreeRecord::has_connectivity(const size_t& record_offset,
                                          const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, connectivity_t connectivity) {
    if (connectivity == START_START) {
        return is_start_start_connected(record_offset, records);
    } else if (connectivity == START_END || connectivity == END_START) {
        return is_start_end_connected(record_offset, records);
    } else if (connectivity == START_TIP || connectivity == TIP_START) {
        return is_start_tip_connected(record_offset, records);
    } else if (connectivity == END_END) {
        return is_end_end_connected(record_offset, records);
    } else if (connectivity == END_TIP || connectivity == TIP_END) {
        return is_end_tip_connected(record_offset, records);
    } else if (connectivity == TIP_TIP) {
        return is_tip_tip_connected(record_offset, records);
    } else {
...
bool SnarlDistanceIndex::SnarlTreeRecord::has_connectivity(const size_t& record_offset, 
    ...
    return has_connectivity(record_offset, records, endpoints_to_connectivity(start, end));
}

size_t SnarlDistanceIndex::SnarlTreeRecord::get_parent_record_offset(const size_t& record_offset,
                                const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distances
    cerr << "Get parent record offset for record at " << record_offset << endl;
#endif
    record_t type = get_record_type(record_offset, records);
    if (type == ROOT) {
        return 0;
...
size_t SnarlDistanceIndex::SnarlTreeRecord::get_min_length(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
    size_t val;
    if (type == DISTANCED_NODE ) {
        ...
        size_t last_node_offset = TrivialSnarlRecord::get_node_count(record_offset, records)-1;
...
size_t SnarlDistanceIndex::SnarlTreeRecord::get_max_length(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
    size_t val;
    if (type == DISTANCED_NODE ) {
...
size_t SnarlDistanceIndex::SnarlTreeRecord::get_rank_in_parent(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
...
bool SnarlDistanceIndex::SnarlTreeRecord::get_is_reversed_in_parent(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
    if (type == NODE || type == DISTANCED_NODE) {
        return false;
...
handlegraph::nid_t SnarlDistanceIndex::SnarlTreeRecord::get_start_id(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
    if (type == ROOT) {
        ...
        size_t parent_record_offset = get_parent_record_offset(record_offset, records);
        size_t node_offset = (type == SIMPLE_SNARL || type == DISTANCED_SIMPLE_SNARL) ? 1 : 0;

        net_handle_t next_node_in_chain = ChainRecord::get_next_child(parent_record_offset, records,    
                    get_net_handle_from_values(record_offset, START_END, SNARL_HANDLE, node_offset), true);

        return TrivialSnarlRecord::get_node_id(get_record_offset(next_node_in_chain), records, get_node_record_offset(next_node_in_chain));
    } else if (type == CHAIN || type == DISTANCED_CHAIN || type == MULTICOMPONENT_CHAIN)  {
...
bool SnarlDistanceIndex::SnarlTreeRecord::get_start_orientation(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
    if (type == ROOT) {
        throw runtime_error("error: trying to get the start node of the root");
...
handlegraph::nid_t SnarlDistanceIndex::SnarlTreeRecord::get_end_id(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    record_t type = get_record_type(record_offset, records);
    if (type == ROOT) {
        ...
        net_handle_t next_node_in_chain = ChainRecord::get_next_child(parent_record_offset, records, 
                get_net_handle_from_values(record_offset, START_END, SNARL_HANDLE, node_offset), false);
...
handlegraph::nid_t SnarlDistanceIndex::SnarlTreeRecord::get_end_orientation(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    record_t type = get_record_type(record_offset, records);
    if (type == ROOT) {
        throw runtime_error("error: trying to get the end node of the root");
...
void SnarlDistanceIndex::SnarlTreeRecord::set_start_start_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
...
void SnarlDistanceIndex::SnarlTreeRecord::set_start_end_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_start_tip_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_end_end_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_end_tip_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_tip_tip_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_externally_start_end_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_externally_start_start_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_externally_end_end_connected(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlTreeRecord::set_record_type(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, record_t type) {
    assert((*records)->at(record_offset) == 0);
    (*records)->at(record_offset) = ((static_cast<size_t>(type) << 9) | ((*records)->at(record_offset) & 511));
}


void SnarlDistanceIndex::SnarlTreeRecord::set_min_length(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t length) {
    record_t type = get_record_type(record_offset, records);
    size_t offset;
    if (type == DISTANCED_NODE) {
...
void SnarlDistanceIndex::SnarlTreeRecord::set_max_length(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t length) {
    record_t type = get_record_type(record_offset, records);
    size_t offset;
    if (type == DISTANCED_NODE) {
...
void SnarlDistanceIndex::SnarlTreeRecord::set_rank_in_parent(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t rank) {
    record_t type = get_record_type(record_offset, records);
    size_t offset;
    if (type == NODE || type == DISTANCED_NODE) {
...
void SnarlDistanceIndex::SnarlTreeRecord::set_is_reversed_in_parent(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, bool rev) {
    record_t type = get_record_type(record_offset, records);
    size_t offset;
...
void SnarlDistanceIndex::SnarlTreeRecord::set_parent_record_offset(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t pointer){
    record_t type = get_record_type(record_offset, records);
    size_t offset;
    if (type == NODE || type == DISTANCED_NODE) {
...
void SnarlDistanceIndex::SnarlTreeRecord::set_start_node(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    handlegraph::nid_t id, bool rev) {
    record_t type = get_record_type(record_offset, records);
    size_t offset;
...
void SnarlDistanceIndex::SnarlTreeRecord::set_end_node(
    const size_t& record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    handlegraph::nid_t id, bool rev)  {
    record_t type = get_record_type(record_offset, records);
    size_t offset;
...
#endif
    return TrivialSnarlRecord::get_prefix_sum(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
}
...
#endif
    return TrivialSnarlRecord::get_forward_loop(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
}
...
#endif
    return TrivialSnarlRecord::get_reverse_loop(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net));
}
...
#endif
    return TrivialSnarlRecord::get_chain_component(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net), get_end);
}
...
size_t SnarlDistanceIndex::RootRecord::get_connected_component_count(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset+COMPONENT_COUNT_OFFSET);
}
size_t SnarlDistanceIndex::RootRecord::get_node_count(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset+NODE_COUNT_OFFSET);
}
size_t SnarlDistanceIndex::RootRecord::get_max_tree_depth(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset+MAX_TREE_DEPTH_OFFSET);
}
size_t SnarlDistanceIndex::RootRecord::get_min_node_id(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset+MIN_NODE_ID_OFFSET);
}

bool SnarlDistanceIndex::RootRecord::for_each_child(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    const std::function<bool(const handlegraph::net_handle_t&)>& iteratee)  {
    size_t connected_component_count = get_connected_component_count(record_offset, records);
    for (size_t i = 0 ; i < connected_component_count ; i++) {

        size_t child_offset = (*records)->at(record_offset + ROOT_RECORD_SIZE + i);
        net_handle_record_t type = SnarlTreeRecord::get_record_handle_type(child_offset, records);
        record_t record_type = SnarlTreeRecord::get_record_type(child_offset, records);
        ...
        if (record_type == ROOT_SNARL || record_type == DISTANCED_ROOT_SNARL) {
            ...
            if (! SnarlRecord::for_each_child(child_offset, records, iteratee)) {
                return false;
            }
        } else {
...
void SnarlDistanceIndex::RootRecord::write_root_record(size_t pointer, size_t connected_component_count, size_t node_count, 
    ...
    set_record_type(pointer, records, ROOT);
    set_min_node_id(pointer, records, min_node_id);
    set_node_count(pointer, records, node_count);
    set_max_tree_depth(pointer, records, max_tree_depth);
    set_connected_component_count(pointer, records, connected_component_count);
...
void SnarlDistanceIndex::RootRecord::set_connected_component_count(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t connected_component_count) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::RootRecord::set_node_count(const size_t& record_offset, 
...
void SnarlDistanceIndex::RootRecord::set_max_tree_depth(const size_t& record_offset, 
...
void SnarlDistanceIndex::RootRecord::set_min_node_id(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,handlegraph::nid_t node_id) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::RootRecord::add_component(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,size_t index, size_t offset) {
#ifdef debug_distance_indexing
    ...
    assert(index < get_connected_component_count(record_offset, records));
#endif
...
nid_t SnarlDistanceIndex::NodeRecord::get_node_id(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset + NODE_ID_OFFSET);
}
size_t SnarlDistanceIndex::NodeRecord::get_node_length(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return get_min_length(record_offset, records);
...
size_t SnarlDistanceIndex::NodeRecord::get_distance_left_start(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
...
size_t SnarlDistanceIndex::NodeRecord::get_distance_right_start(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + NODE_DISTANCE_RIGHT_START_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}
size_t SnarlDistanceIndex::NodeRecord::get_distance_left_end(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + NODE_DISTANCE_LEFT_END_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}
size_t SnarlDistanceIndex::NodeRecord::get_distance_right_end(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + NODE_DISTANCE_RIGHT_END_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}

size_t SnarlDistanceIndex::NodeRecord::write_node_record (record_t type,
             bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* snarl_records, nid_t node_id){

    size_t record_offset = (*snarl_records)->size();
    
    (*snarl_records)->resize(record_offset + NODE_RECORD_SIZE); 
#ifdef count_allocations
    cerr << "new_node\t" <<  NODE_RECORD_SIZE << "\t" << (*snarl_records)->size() << endl;
#endif
    set_record_type(record_offset, snarl_records, type);
    set_start_end_connected(record_offset, snarl_records);
    ...
    cerr << get_node_pointer_offset(node_id,
                                           (*snarl_records)->at(MIN_NODE_ID_OFFSET),
                                           (*snarl_records)->at(COMPONENT_COUNT_OFFSET))
         << " Set pointer to node " << node_id << " record: " << record_offset << endl;
#endif
    //Tell the root where to find this node, and a 0 for the offset in a trivial snarl
    (*snarl_records)->at(get_node_pointer_offset(node_id,
                                           (*snarl_records)->at(MIN_NODE_ID_OFFSET),
                                           (*snarl_records)->at(COMPONENT_COUNT_OFFSET))) = record_offset;
    (*snarl_records)->at(get_node_pointer_offset(node_id,
                                           (*snarl_records)->at(MIN_NODE_ID_OFFSET),
                                           (*snarl_records)->at(COMPONENT_COUNT_OFFSET))+1) = 0;

    return record_offset;
}


void SnarlDistanceIndex::NodeRecord::set_node_id(const size_t& record_offset, 
...
void SnarlDistanceIndex::NodeRecord::set_node_length(const size_t& record_offset, 
...
void SnarlDistanceIndex::NodeRecord::set_rank_in_parent(const size_t& record_offset, 
...
void SnarlDistanceIndex::NodeRecord::set_distance_left_start(const size_t& record_offset, 
...
void SnarlDistanceIndex::NodeRecord::set_distance_right_start(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + NODE_DISTANCE_RIGHT_START_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}
void SnarlDistanceIndex::NodeRecord::set_distance_left_end(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + NODE_DISTANCE_LEFT_END_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}
void SnarlDistanceIndex::NodeRecord::set_distance_right_end(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + NODE_DISTANCE_RIGHT_END_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}

size_t SnarlDistanceIndex::TrivialSnarlRecord::write_trivial_snarl_record (record_t type,
...
#endif
    size_t record_offset = (*records)->size();
 
    (*records)->resize(record_offset + TRIVIAL_SNARL_RECORD_SIZE);
    set_record_type(record_offset, records, type);
    set_start_end_connected(record_offset, records );
#ifdef count_allocations
    cerr << "new_trivial_snarl\t" << TRIVIAL_SNARL_RECORD_SIZE << "\t" << (*records)->size() << endl;
#endif
    return record_offset;
}
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_node_count(
    const size_t& record_offset, const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records){ 
    return (*records)->at(record_offset+TRIVIAL_SNARL_NODE_COUNT_OFFSET);
}

tuple<size_t, size_t, size_t, size_t> SnarlDistanceIndex::TrivialSnarlRecord::get_chain_values(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank) {
#ifdef debug_distances
    assert(get_record_type(record_offset, records) == TRIVIAL_SNARL || get_record_type(record_offset, records) == DISTANCED_TRIVIAL_SNARL);
#endif
    ...
    size_t parent_offset = get_parent_record_offset(record_offset, records);
    size_t component = (node_rank == 0 && record_offset == ChainRecord::get_first_node_offset(parent_offset, records)) ? 0: (*records)->at(record_offset+TRIVIAL_SNARL_COMPONENT_OFFSET); 
    ...
    size_t last_node = get_node_count(record_offset, records)-1; 
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_max_prefix_sum(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
#ifdef debug_distances
    assert(get_record_type(record_offset, records) == TRIVIAL_SNARL || get_record_type(record_offset, records) == DISTANCED_TRIVIAL_SNARL);
#endif
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_prefix_sum(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
#ifdef debug_distances
    assert(get_record_type(record_offset, records) == TRIVIAL_SNARL || get_record_type(record_offset, records) == DISTANCED_TRIVIAL_SNARL);
#endif
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_forward_loop(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
#ifdef debug_distances
    assert(get_record_type(record_offset, records)== TRIVIAL_SNARL || get_record_type(record_offset, records) == DISTANCED_TRIVIAL_SNARL);
#endif
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_reverse_loop(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
#ifdef debug_distances
    assert(get_record_type(record_offset, records) == TRIVIAL_SNARL || get_record_type(record_offset, records) == DISTANCED_TRIVIAL_SNARL);
#endif
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_chain_component(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank, bool get_end)  {
    size_t parent_offset = get_parent_record_offset(record_offset, records);
    if (!get_end && node_rank == 0 && record_offset == ChainRecord::get_first_node_offset(parent_offset, records)){
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_node_length(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
    if (node_rank == 0) {
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_rank_in_parent(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
    return record_offset+node_rank;
}
nid_t SnarlDistanceIndex::TrivialSnarlRecord::get_node_id(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
    return (*records)->at(record_offset + TRIVIAL_SNARL_RECORD_SIZE + (2*node_rank)) >> 1;
}
bool SnarlDistanceIndex::TrivialSnarlRecord::get_is_reversed_in_parent(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_rank)  {
    return (*records)->at(record_offset + TRIVIAL_SNARL_RECORD_SIZE + (2*node_rank)) & 1;
}


void SnarlDistanceIndex::TrivialSnarlRecord::set_node_count(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value)  {
    (*records)->at(record_offset+TRIVIAL_SNARL_NODE_COUNT_OFFSET)=value;
}
void SnarlDistanceIndex::TrivialSnarlRecord::set_prefix_sum(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value)  {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::TrivialSnarlRecord::set_max_prefix_sum(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value)  {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::TrivialSnarlRecord::set_forward_loop(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value)  { 
#ifdef debug_distance_indexing
    cerr <<record_offset + TRIVIAL_SNARL_FORWARD_LOOP_OFFSET << " set node forward loop " << value << endl;
    assert(get_record_type(record_offset, records) == DISTANCED_TRIVIAL_SNARL);
#endif
    value = value == std::numeric_limits<size_t>::max() ? 0 : value +1;
    (*records)->at(record_offset + TRIVIAL_SNARL_FORWARD_LOOP_OFFSET) = value;
}
void SnarlDistanceIndex::TrivialSnarlRecord::set_reverse_loop(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value)  {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::TrivialSnarlRecord::set_chain_component(const size_t& record_offset, 
    bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value)  {
#ifdef debug_distance_indexing
...
size_t SnarlDistanceIndex::TrivialSnarlRecord::get_record_size(const size_t& record_offset,
                   const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return TRIVIAL_SNARL_RECORD_SIZE + (get_node_count(record_offset, records) * 2);
}
...
size_t SnarlDistanceIndex::SnarlRecord::record_size(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    record_t type = get_record_type(record_offset, records);
    return record_size(type, get_node_count(record_offset, records));
}
...
size_t SnarlDistanceIndex::SnarlRecord::get_distance_vector_offset(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    ...
    return get_distance_vector_offset(rank1, right_side1, rank2, right_side2,
        get_node_count(record_offset, records), get_record_type(record_offset, records));
}


size_t SnarlDistanceIndex::SnarlRecord::get_distance_start_start(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    size_t stored_value = (*records)->at(record_offset + SNARL_DISTANCE_START_START_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}
size_t SnarlDistanceIndex::SnarlRecord::get_distance_end_end(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    size_t stored_value = (*records)->at(record_offset + SNARL_DISTANCE_END_END_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}

size_t SnarlDistanceIndex::SnarlRecord::get_distance(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    size_t rank1, bool right_side1, size_t rank2, bool right_side2)  {
    if (get_record_type(record_offset, records) == OVERSIZED_SNARL) {
    ...
    size_t distance_vector_offset = get_distance_vector_offset(record_offset, records,
                                        rank1, right_side1, rank2, right_side2);
...
size_t SnarlDistanceIndex::SnarlRecord::get_node_count(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset + SNARL_NODE_COUNT_OFFSET);
}

size_t SnarlDistanceIndex::SnarlRecord::get_child_record_pointer(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    return (*records)->at(record_offset+SNARL_CHILD_RECORD_OFFSET) ;
}

bool SnarlDistanceIndex::SnarlRecord::for_each_child(const size_t& record_offset, 
    const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    const std::function<bool(const net_handle_t&)>& iteratee)  {
    size_t child_count = get_node_count(record_offset, records);
    size_t child_record_offset = get_child_record_pointer(record_offset, records);
...
size_t SnarlDistanceIndex::SnarlRecord::write_snarl_record (size_t node_count, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, record_t type){
...
#endif
    (*records)->resize(record_offset + extra_size);
    set_node_count(record_offset, records, node_count);
    set_record_type(record_offset, records, type);
...
void SnarlDistanceIndex::SnarlRecord::set_distance_start_start(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value) {
    (*records)->at(record_offset + SNARL_DISTANCE_START_START_OFFSET) = (value == std::numeric_limits<size_t>::max() ? 0 : value + 1);
}
void SnarlDistanceIndex::SnarlRecord::set_distance_end_end(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t value) {
...
void SnarlDistanceIndex::SnarlRecord::set_distance(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
    ...
    assert((get_distance(record_offset, records, rank1, right_side1, rank2, right_side2) == std::numeric_limits<size_t>::max() ||
           get_distance(record_offset, records, rank1, right_side1, rank2, right_side2) == distance));
#endif
    //Don't save internal distances for oversized snarls
    if (get_record_type(record_offset, records) == OVERSIZED_SNARL && !(rank1 == 0 || rank1 == 1 || rank2 == 0 || rank2 == 1)){
        return;
    }
    ...
    size_t distance_vector_offset = get_distance_vector_offset(record_offset, records,
                                        rank1, right_side1, rank2, right_side2);
    assert(distance_vector_offset <= distance_vector_size(get_record_type(record_offset, records), 
                                                          get_node_count(record_offset, records))); 
...
void SnarlDistanceIndex::SnarlRecord::set_node_count(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_count) {
#ifdef debug_distance_indexing
...
void SnarlDistanceIndex::SnarlRecord::set_child_record_pointer(const size_t& record_offset, 
...
//to here
void SnarlDistanceIndex::SnarlRecord::add_child(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t pointer){
#ifdef debug_distance_indexing
...
size_t SnarlDistanceIndex::SimpleSnarlRecord::write_simple_snarl_record(size_t node_count, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, record_t type){
...
#endif
    size_t record_offset = (*records)->size();
    (*records)->resize(record_offset + SIMPLE_SNARL_RECORD_SIZE + 2*node_count);
    set_node_count(record_offset, records, node_count);
    set_record_type(record_offset, records, type);
    set_node_count(record_offset, records, node_count);
    set_start_end_connected(record_offset, records);
...
size_t SnarlDistanceIndex::SimpleSnarlRecord::record_size(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    
    return SIMPLE_SNARL_RECORD_SIZE + get_node_count(record_offset, records)*2;
}
size_t SnarlDistanceIndex::SimpleSnarlRecord::get_node_count(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {

    return (*records)->at(record_offset + SIMPLE_SNARL_NODE_COUNT_AND_LENGTHS_OFFSET) >> 22;
}

nid_t SnarlDistanceIndex::SimpleSnarlRecord::get_node_id(const size_t& record_offset, 
...
size_t SnarlDistanceIndex::SimpleSnarlRecord::get_node_length(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t rank)  {
    assert(rank >=2);
    assert(rank != std::numeric_limits<size_t>::max());
    return (*records)->at(record_offset + SIMPLE_SNARL_RECORD_SIZE + ((rank-2)*2) + 1) >> 1;
}
bool SnarlDistanceIndex::SimpleSnarlRecord::get_node_is_reversed(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t rank)  {
    assert(rank>=2);
    assert(rank != std::numeric_limits<size_t>::max());
    return (*records)->at(record_offset + SIMPLE_SNARL_RECORD_SIZE + ((rank-2)*2) + 1) & 1;
}
size_t SnarlDistanceIndex::SimpleSnarlRecord::get_distance(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
        size_t rank1, bool right_side1, size_t rank2, bool right_side2)  {
    if (rank1 > rank2) {
        //Order the nodes
    ...
    if (rank1 == 0 && rank2 == 1) {
        ...
        if( get_node_is_reversed(record_offset, records, rank2) == right_side2) {
            return 0;
        } else {
            return std::numeric_limits<size_t>::max();
        }
...
bool SnarlDistanceIndex::SimpleSnarlRecord::for_each_child(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
        const std::function<bool(const net_handle_t&)>& iteratee)  {
    size_t node_count = get_node_count(record_offset, records);
...
void SnarlDistanceIndex::SimpleSnarlRecord::set_node_count(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_count) {
...
void SnarlDistanceIndex::SimpleSnarlRecord::add_child(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
...
size_t SnarlDistanceIndex::ChainRecord::get_node_count(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    if (get_record_handle_type(record_offset, records) == NODE_HANDLE) {
        return 1;
    } else {
...
tuple<size_t, bool, size_t> SnarlDistanceIndex::ChainRecord::get_last_child_offset(
    ...
    if (get_record_handle_type(record_offset, records) == NODE_HANDLE) {
        ...
        size_t node_record_offset = is_snarl ? 0 : TrivialSnarlRecord::get_node_count(record_offset, records)-1;
        return make_tuple(record_offset, is_snarl, node_record_offset);
    }
}
bool SnarlDistanceIndex::ChainRecord::get_is_looping_chain_connected_backwards(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    if (get_record_handle_type(record_offset, records) == NODE_HANDLE) {
        throw runtime_error("error: Trying to get children of a node");
    } else {
...
size_t SnarlDistanceIndex::ChainRecord::get_distance(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
        size_t rank1, bool left_side1, size_t node_length1, 
    ...
    bool is_looping_chain = get_start_id(record_offset, records) == get_end_id(record_offset, records);
#ifdef debug_distances
    if (get_record_handle_type(record_offset, records) == NODE_HANDLE) {
    ...
    if (get_record_type(record_offset, records) == MULTICOMPONENT_CHAIN) {
        if (component1 != component2) {
            if (is_looping_chain) {
                //If this is a looping chain, then the first/last node could be in two
                //components
                return get_distance_taking_chain_loop(record_offset, records, rank1, left_side1, node_length1, 
    ...
    if (is_looping_chain) {
        distance = std::min(distance, get_distance_taking_chain_loop(record_offset, records,
                            rank1, left_side1, node_length1, 
                            prefix_sum1, forward_loop1, reverse_loop1, end_component1,
                            rank2, left_side2, node_length2,
                            prefix_sum2, forward_loop2, reverse_loop2, end_component2));
    }
...
size_t SnarlDistanceIndex::ChainRecord::get_distance_taking_chain_loop(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
        size_t rank1, bool left_side1, size_t node_length1, 
...
#ifdef debug_distances
    assert (rank1 <= rank2);
    assert(get_start_id(record_offset, records) == get_end_id(record_offset, records));
    assert(get_record_handle_type(record_offset, records) != NODE_HANDLE);
#endif
     ...
     */
     if (get_record_type(record_offset, records) == MULTICOMPONENT_CHAIN) {
        size_t last_component = TrivialSnarlRecord::get_chain_component(
                                    get_first_node_offset(record_offset, records) , records, 0, true);
        ...
        bool can_loop = get_is_looping_chain_connected_backwards(record_offset, records);
    ...
    if (!left_side1 && left_side2) {
        ...
        distance = sum({forward_loop1, node_length1, prefix_sum1,
                        minus(get_min_length(record_offset, records), prefix_sum2),
                        reverse_loop2});
    } else if (!left_side1 && !left_side2) {
        //Right side of 1 and right side of 2
        ...
        distance = sum({forward_loop1, node_length1, prefix_sum1,
                        minus(minus(get_min_length(record_offset, records), prefix_sum2), node_length2)});
    } else if (left_side1 && left_side2) {
        //Left side of 1 and left side of 2
        ...
        distance = sum({prefix_sum1,
                        minus(get_min_length(record_offset, records), prefix_sum2),reverse_loop2});
    } else {
        //Left side of 1 and right side of 2
...
size_t SnarlDistanceIndex::ChainRecord::get_distance_left_start(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + CHAIN_DISTANCE_LEFT_START_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}
size_t SnarlDistanceIndex::ChainRecord::get_distance_right_start(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + CHAIN_DISTANCE_RIGHT_START_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}
size_t SnarlDistanceIndex::ChainRecord::get_distance_left_end(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + CHAIN_DISTANCE_LEFT_END_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}
size_t SnarlDistanceIndex::ChainRecord::get_distance_right_end(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    size_t stored_value = (*records)->at(record_offset + CHAIN_DISTANCE_RIGHT_END_OFFSET);
    return stored_value == 0 ? std::numeric_limits<size_t>::max() : stored_value - 1;
}

size_t SnarlDistanceIndex::ChainRecord::get_first_node_offset(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records)  {
    if (get_record_handle_type(record_offset, records) == NODE_HANDLE) {
...
net_handle_t SnarlDistanceIndex::ChainRecord::get_next_child(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
    ...
    if (get_handle_type(net_handle) == NODE_HANDLE) {
        ...
        if (go_left && get_node_record_offset(net_handle) != 0) {
            ...
            if (get_node_record_offset(net_handle) == 1 && get_record_offset(net_handle) == get_first_node_offset(record_offset, records) &&
                get_start_id(record_offset, records) == get_end_id(record_offset, records)) {
            ...
            return get_net_handle_from_values(get_record_offset(net_handle), connectivity, 
                      ...
                      TrivialSnarlRecord::get_node_count(get_record_offset(net_handle), records)-1){
    ...
    if (go_left && get_record_offset(net_handle) == get_first_node_offset(record_offset, records) ) {
...
#endif
        if (get_start_id(record_offset, records) != get_end_id(record_offset, records)) {
            ...
            tuple<size_t, bool, size_t> last_child = get_last_child_offset(record_offset, records);
            bool is_reversed_in_parent = std::get<1>(last_child) ? false : 
                TrivialSnarlRecord::get_is_reversed_in_parent(get_first_node_offset(record_offset, records), records, 
                        TrivialSnarlRecord::get_node_count(get_first_node_offset(record_offset, records),records)-1);
    ...
    } else if (!go_left && get_record_offset(net_handle) == std::get<0>(get_last_child_offset(record_offset, records))) {
        ...
        if (get_start_id(record_offset, records) != get_end_id(record_offset, records)) {
            ...
            bool is_reversed_in_parent = TrivialSnarlRecord::get_is_reversed_in_parent(get_first_node_offset(record_offset, records),records, 0);
            return get_net_handle_from_values(get_first_node_offset(record_offset, records), 
    ...
    record_t next_record_type = get_record_type(next_pointer, records);
    if (next_record_type == SNARL || next_record_type == DISTANCED_SNARL|| next_record_type == OVERSIZED_SNARL) {
    ...
    } else if (next_record_type == SIMPLE_SNARL || next_record_type == DISTANCED_SIMPLE_SNARL) {
        //If the next thing is a snarl, then just return the snarl going in the direction we just moved in
        ...
        size_t node_offset = go_left ? TrivialSnarlRecord::get_node_count(next_pointer, records)-1 : 0;

        //Is the next node (the first thing in the snarl if we're going right, last thing if we're going left) reversed
        bool next_is_reversed_in_parent = TrivialSnarlRecord::get_is_reversed_in_parent(next_pointer, records, node_offset);
...
bool SnarlDistanceIndex::ChainRecord::for_each_child(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records,
        const std::function<bool(const net_handle_t&)>& iteratee)  {
    ...
    size_t first_node_offset = get_first_node_offset(record_offset, records);
    bool rev_in_parent = TrivialSnarlRecord::get_is_reversed_in_parent(first_node_offset, records, 0);
    ...
    while (true) {
        ...
        net_handle_t next_child = get_next_child(record_offset, records, current_child, false);
...
size_t SnarlDistanceIndex::ChainRecord::write_chain_record (record_t type, size_t node_count, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records){
#ifdef debug_distance_indexing
    assert(type == CHAIN ||
...
#endif
    size_t record_offset = (*records)->size();
    (*records)->resize(record_offset + CHAIN_RECORD_SIZE);
    set_node_count(record_offset, records,node_count);
    set_record_type(record_offset, records,type);
#ifdef count_allocations
...
void SnarlDistanceIndex::ChainRecord::set_node_count(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t node_count) {
#ifdef debug_distance_indexing
...
size_t SnarlDistanceIndex::ChainRecord::get_depth(const size_t& record_offset, 
        const bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records) {
    return (*records)->at(record_offset+CHAIN_DEPTH_OFFSET) ;
}
void SnarlDistanceIndex::ChainRecord::set_depth(const size_t& record_offset, 
...
void SnarlDistanceIndex::ChainRecord::set_last_child_offset(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
...
void SnarlDistanceIndex::ChainRecord::set_distance_left_start(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + CHAIN_DISTANCE_LEFT_START_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}
void SnarlDistanceIndex::ChainRecord::set_distance_right_start(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + CHAIN_DISTANCE_RIGHT_START_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}
void SnarlDistanceIndex::ChainRecord::set_distance_left_end(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + CHAIN_DISTANCE_LEFT_END_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}
void SnarlDistanceIndex::ChainRecord::set_distance_right_end(const size_t& record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, size_t distance) {
    (*records)->at(record_offset + CHAIN_DISTANCE_RIGHT_END_OFFSET) = (distance == std::numeric_limits<size_t>::max() ? 0 : distance + 1);
}

//Add a snarl to the end of the chain and return a SnarlRecord pointing to it
size_t SnarlDistanceIndex::ChainRecord::add_snarl(
        const size_t& parent_record_offset, bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
    ...
    assert(get_record_type(previous_child_offset, records)== DISTANCED_TRIVIAL_SNARL);
#endif

    
    //The last child we saw was a trivial snarl and we need to record its size
    (*records)->at(previous_child_offset-1) = TrivialSnarlRecord::get_record_size(previous_child_offset, records);
    size_t current_size = (*records)->size();
    (*records)->resize(current_size+1);
    (*records)->at(current_size) = TrivialSnarlRecord::get_record_size(previous_child_offset, records);
    ...
    size_t snarl_record_offset = SnarlRecord::write_snarl_record(snarl_size, records, type);
    SnarlRecord::set_parent_record_offset(snarl_record_offset, records, parent_record_offset);
#ifdef debug_distance_indexing
    cerr << (*records)->size() << " Adding child snarl length to the end of the array " << endl;
#endif
...
#endif
    return snarl_record_offset;
}
//Add a simple snarl to the end of the chain and return a SnarlRecord pointing to it
size_t SnarlDistanceIndex::ChainRecord::add_simple_snarl(const size_t& parent_record_offset,
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
        size_t snarl_size, record_t type, size_t previous_child_offset) {
    ...
    (*records)->at(start_i) = snarl_record_size;
    (*records)->reserve(start_i + snarl_record_size);
    size_t snarl_record_offset = SimpleSnarlRecord::write_simple_snarl_record(snarl_size, records, type);
    SimpleSnarlRecord::set_parent_record_offset(snarl_record_offset, records, parent_record_offset);
#ifdef debug_distance_indexing
    cerr << (*records)->size() << " Adding child snarl length to the end of the array " << endl;
#endif
    start_i = (*records)->size();
...
size_t SnarlDistanceIndex::ChainRecord::add_node(const size_t& parent_record_offset, 
        bdsg::yomo::UniqueMappedPointer<bdsg::MappedIntVector>* records, 
...
#endif
    if (get_record_type(previous_child_offset, records) == DISTANCED_TRIVIAL_SNARL
            && (TrivialSnarlRecord::get_node_count(previous_child_offset, records) == MAX_TRIVIAL_SNARL_NODE_COUNT 
                || new_record)) {
    ...
    record_t previous_record_type = get_record_type(previous_child_offset, records);
    if (previous_child_offset == 0 || previous_record_type == DISTANCED_SNARL 
            || previous_record_type == OVERSIZED_SNARL || previous_record_type == DISTANCED_SIMPLE_SNARL 
            || TrivialSnarlRecord::get_node_count(previous_child_offset, records) == MAX_TRIVIAL_SNARL_NODE_COUNT
        ...
        size_t trivial_snarl_record_offset = TrivialSnarlRecord::write_trivial_snarl_record(
                                                DISTANCED_TRIVIAL_SNARL, records);
        TrivialSnarlRecord::set_parent_record_offset(trivial_snarl_record_offset, records, parent_record_offset);
        TrivialSnarlRecord::set_node_count(trivial_snarl_record_offset, records, 1);
        TrivialSnarlRecord::set_prefix_sum(trivial_snarl_record_offset, records, prefix_sum);
        TrivialSnarlRecord::set_max_prefix_sum(trivial_snarl_record_offset, records, max_prefix_sum);;
        TrivialSnarlRecord::set_forward_loop(trivial_snarl_record_offset, records, forward_loop);
        TrivialSnarlRecord::set_reverse_loop(trivial_snarl_record_offset, records, reverse_loop);
        TrivialSnarlRecord::set_chain_component(trivial_snarl_record_offset, records, component);
        ...
        return trivial_snarl_record_offset;
    } else {
    ...
    cerr << "trivial_snarl\t2\t" <<  (*records)->size() << endl;
        ...
        size_t old_node_count = TrivialSnarlRecord::get_node_count(previous_child_offset, records);
        TrivialSnarlRecord::set_node_count(previous_child_offset, records, old_node_count+1);
        //The forward loop value changes
        TrivialSnarlRecord::set_forward_loop(previous_child_offset, records, forward_loop);
        ...
        return previous_child_offset;
    }
}
string SnarlDistanceIndex::net_handle_as_string(const net_handle_t& net) const {
#ifdef debug_distances
    cerr << "Print record at offset " << get_record_offset(net) << endl;
#endif
    net_handle_record_t type = get_handle_type(net);
    size_t record_offset = get_record_offset(net);
    net_handle_record_t record_type = SnarlTreeRecord::get_record_handle_type(record_offset, &snarl_tree_records);
    string result;
    if (type == ROOT_HANDLE) {
        if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == ROOT_SNARL 
                || SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == DISTANCED_ROOT_SNARL) {
            return "root snarl";
        } else {
            return "root"; 
        }
        ...
        if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) == ROOT) {
            return "root snarl";
        }
        ...
        return  "node " + std::to_string( NodeRecord::get_node_id(get_record_offset(net), &snarl_tree_records))
               + (ends_at(net) == START ? "rev" : "fd") + " pretending to be a chain";
    }  else if (type == CHAIN_HANDLE && record_type == SNARL_HANDLE) {
        return  "node " + std::to_string( SimpleSnarlRecord::get_node_id(get_record_offset(net), &snarl_tree_records, get_node_record_offset(net)))
    ...
    result += ( std::to_string(SnarlTreeRecord::get_start_id(record_offset, &snarl_tree_records))
            + (SnarlTreeRecord::get_start_orientation(record_offset, &snarl_tree_records) ? "rev" : "fd")
            + "->"
            + std::to_string(SnarlTreeRecord::get_end_id(record_offset, &snarl_tree_records))
            + (SnarlTreeRecord::get_end_orientation(record_offset, &snarl_tree_records) ? "rev" : "fd"));
    result += "traversing ";
...
void SnarlDistanceIndex::print_descendants_of(const net_handle_t net) const {
    ...
    net_handle_record_t record_handle_type = SnarlTreeRecord::get_record_handle_type(
                                                    get_record_offset(net), &snarl_tree_records);
    //What the record actually is
    record_t record_type = SnarlTreeRecord::get_record_type(
                                                    get_record_offset(net), &snarl_tree_records);
    if (record_handle_type == NODE_HANDLE) {
        net_handle_t parent = get_parent(net);
        ...
        size_t child_count;
        string parent;
        if (record_handle_type == ROOT_HANDLE) {
            parent = "none";
            child_count = RootRecord::get_connected_component_count(get_record_offset(net), &snarl_tree_records);
        } else {
            parent = net_handle_as_string(get_parent(net));
            if (record_handle_type == CHAIN_HANDLE) {
                child_count =  ChainRecord::get_node_count(get_record_offset(net), &snarl_tree_records);
            } else if (record_type == SNARL ||
                        record_type == DISTANCED_SNARL||
                        record_type == OVERSIZED_SNARL  
                        ){
 
                child_count = SnarlRecord::get_node_count(get_record_offset(net), &snarl_tree_records);
            } else if (record_type == TRIVIAL_SNARL ||
                        record_type == DISTANCED_TRIVIAL_SNARL) {
                child_count = TrivialSnarlRecord::get_node_count(get_record_offset(net), &snarl_tree_records);
            }else if (record_type == SIMPLE_SNARL ||
                        record_type == DISTANCED_SIMPLE_SNARL) {
                child_count = SimpleSnarlRecord::get_node_count(get_record_offset(net), &snarl_tree_records);
            } else {
...
void SnarlDistanceIndex::print_snarl_stats() const {
    ...
    traverse_decomposition(
        [&](const net_handle_t& snarl_child) {
            ...
            size_t snarl_child_offset = get_record_offset(snarl_child);

            //Get the number of children depending on the type of record
            size_t child_count;
            if (SnarlTreeRecord::get_record_type(snarl_child_offset, &snarl_tree_records) == SNARL ||
                        SnarlTreeRecord::get_record_type(snarl_child_offset, &snarl_tree_records) == DISTANCED_SNARL||
                        SnarlTreeRecord::get_record_type(snarl_child_offset, &snarl_tree_records) == OVERSIZED_SNARL  
                        ){
 
                child_count = SnarlRecord::get_node_count(snarl_child_offset, &snarl_tree_records);
            } else if (SnarlTreeRecord::get_record_type(snarl_child_offset, &snarl_tree_records) == SIMPLE_SNARL ||
                        SnarlTreeRecord::get_record_type(snarl_child_offset, &snarl_tree_records) == DISTANCED_SIMPLE_SNARL) {
                child_count = SimpleSnarlRecord::get_node_count(snarl_child_offset, &snarl_tree_records);
            } else {
                throw runtime_error("error: getting the snarl child count of the wrong type of record");
            }
            //Print the stats
            cout << SnarlTreeRecord::get_start_id(snarl_child_offset, &snarl_tree_records) << "\t" 
                 << SnarlTreeRecord::get_end_id(snarl_child_offset, &snarl_tree_records) << "\t" 
                 << child_count << "\t" 
...
void SnarlDistanceIndex::write_snarls_to_json() const {
    traverse_decomposition(
        [&](const net_handle_t& snarl_child) {
            ...
            //Get the number of children depending on the type of record
            record_t snarl_child_type = SnarlTreeRecord::get_record_type(snarl_child_offset, &snarl_tree_records);
            if ( snarl_child_type == SNARL || snarl_child_type == DISTANCED_SNARL 
                      || snarl_child_type == OVERSIZED_SNARL   ){
                size_t child_count = SnarlRecord::get_node_count(snarl_child_offset, &snarl_tree_records);
                json_object_set_new(out_json, "child_count", json_integer(child_count)); 
            } else if (snarl_child_type == SIMPLE_SNARL || snarl_child_type == DISTANCED_SIMPLE_SNARL) {
                size_t child_count = SimpleSnarlRecord::get_node_count(snarl_child_offset, &snarl_tree_records);
                json_object_set_new(out_json, "child_count", json_integer(child_count)); 
            } else {
                throw runtime_error("error: getting the snarl child count of the wrong type of record");
            }
            ...
            if (snarl_child_type == DISTANCED_SNARL || snarl_child_type == DISTANCED_SIMPLE_SNARL){
        ...
        [&](const net_handle_t& chain_child) {
            ...
            size_t chain_child_offset = get_record_offset(chain_child);
            ...
            //Get the number of children depending on the type of record
            json_object_set_new(out_json, "child_count", json_integer(ChainRecord::get_node_count(get_record_offset(chain_child), &snarl_tree_records))); 

            //Set the min and max length, if applicable
            if (ChainRecord::get_record_type(get_record_offset(chain_child), &snarl_tree_records) == DISTANCED_CHAIN) {
...
void SnarlDistanceIndex::validate_index() const {
    ...
    size_t node_count = 0;
    size_t max_node_id = RootRecord::get_min_node_id(get_record_offset(root), &snarl_tree_records) 
                        + RootRecord::get_node_count(get_record_offset(root), &snarl_tree_records);
    for (nid_t id = RootRecord::get_min_node_id(get_record_offset(root), &snarl_tree_records) ; id < max_node_id ; id++){
        if (has_node(id)) {
...
void SnarlDistanceIndex::validate_descendants_of(net_handle_t net) const {
    ...
    //What the record thinks it is
    net_handle_record_t record_type = SnarlTreeRecord::get_record_handle_type(get_record_offset(net), &snarl_tree_records);
...
void SnarlDistanceIndex::get_snarl_tree_records(const vector<const TemporaryDistanceIndex*>& temporary_indexes, const HandleGraph* graph) {
    ...
    RootRecord::write_root_record(0, total_component_count, max_node_id-min_node_id+1, maximum_tree_depth, min_node_id, &snarl_tree_records);
#ifdef debug_distance_indexing
    ...
    for (size_t temp_index_i = 0 ; temp_index_i < temporary_indexes.size() ; temp_index_i++) {
        ...
        while (!temp_record_stack.empty()) {
            ...
            if (current_record_index.first == TEMP_CHAIN) {
                ...
                if (!temp_chain_record.is_trivial) {
                    ...
                    //Write a new chain record at the end of snarl_tree_records and remember its offset
                    size_t chain_record_offset;
                    if (temp_chain_record.chain_components.back() == 0 || snarl_size_limit == 0) {
                        ...
                        chain_record_offset = ChainRecord::write_chain_record(record_type,
                                                        temp_chain_record.prefix_sum.size(), &snarl_tree_records);
                        ChainRecord::set_start_end_connected(chain_record_offset, &snarl_tree_records);
                    } else {
                        chain_record_offset = ChainRecord::write_chain_record(MULTICOMPONENT_CHAIN,
                                                        temp_chain_record.prefix_sum.size(), &snarl_tree_records);
                    }
                    ChainRecord::set_parent_record_offset(chain_record_offset, &snarl_tree_records,
                            record_to_offset[make_pair(temp_index_i, temp_chain_record.parent)]);
                    ChainRecord::set_distance_left_start(chain_record_offset, 
                                    &snarl_tree_records,temp_chain_record.distance_left_start);
                    ChainRecord::set_distance_right_start(chain_record_offset, 
                                    &snarl_tree_records,temp_chain_record.distance_right_start);
                    ChainRecord::set_distance_left_end(chain_record_offset, 
                                    &snarl_tree_records,temp_chain_record.distance_left_end);
                    ChainRecord::set_distance_right_end(chain_record_offset, 
                                    &snarl_tree_records,temp_chain_record.distance_right_end);
                    ...
                    if (temp_chain_record.parent.first == TEMP_ROOT || is_child_of_root_snarl) {
                        ...
                        ChainRecord::set_depth(chain_record_offset, &snarl_tree_records, 1);
                    } else {
                        //Otherwise, go to the grandparent chain and add 1
                        size_t parent_record_offset = ChainRecord::get_parent_record_offset(chain_record_offset, &snarl_tree_records);
                        size_t grandparent_record_offset = SnarlRecord::get_parent_record_offset(parent_record_offset, &snarl_tree_records);  
                        ChainRecord::set_depth(chain_record_offset, &snarl_tree_records,
                            ChainRecord::get_depth(grandparent_record_offset, &snarl_tree_records) + 1);
                    }


                    ChainRecord::set_min_length(chain_record_offset, &snarl_tree_records,
                            temp_chain_record.min_length);
                    ChainRecord::set_max_length(chain_record_offset, &snarl_tree_records,
                            temp_chain_record.max_length);
                    ChainRecord::set_rank_in_parent(chain_record_offset, &snarl_tree_records,
                            temp_chain_record.rank_in_parent);
                    ChainRecord::set_start_node(chain_record_offset, &snarl_tree_records,
                            temp_chain_record.start_node_id, temp_chain_record.start_node_rev);
                    ChainRecord::set_end_node(chain_record_offset, &snarl_tree_records,
                            temp_chain_record.end_node_id, temp_chain_record.end_node_rev);
                    ...
                    for (size_t child_record_index_i = 0 ; child_record_index_i < temp_chain_record.children.size() ; child_record_index_i++) {
                        ...
                        if (child_record_index.first == TEMP_NODE) {
                            ...
                            if (!(chain_node_i != 0 && child_record_index == temp_chain_record.children.front())) {
                                ...
                                size_t new_offset = ChainRecord::add_node(
                                        chain_record_offset, &snarl_tree_records,
                            ...
                            if (!temp_snarl_record.is_trivial && !temp_snarl_record.is_simple) {
                                ...
                                size_t snarl_record_offset =
                                    ChainRecord::add_snarl(chain_record_offset, &snarl_tree_records, temp_snarl_record.node_count, record_type, last_child_offset.first);

                                //Record how to find the new snarl record
                                record_to_offset.emplace(make_pair(temp_index_i, child_record_index), snarl_record_offset);

                                //Fill in snarl info
                                SnarlRecord::set_min_length(snarl_record_offset, &snarl_tree_records, temp_snarl_record.min_length);
                                SnarlRecord::set_max_length(snarl_record_offset, &snarl_tree_records, temp_snarl_record.max_length);
                                SnarlRecord::set_distance_start_start(snarl_record_offset, &snarl_tree_records, temp_snarl_record.distance_start_start);
                                SnarlRecord::set_distance_end_end(snarl_record_offset, &snarl_tree_records, temp_snarl_record.distance_end_end);
                                ...
                                for (const auto& it : temp_snarl_record.distances) {
                                    ...
                                    if (snarl_size_limit != 0) {
                                        ...
                                        SnarlRecord::set_distance(snarl_record_offset, &snarl_tree_records,
                                            node_rank1.first, node_rank1.second,
                                        ...
                                        if (temp_snarl_record.tippy_child_ranks.count(node_rank1.first)
                                            ...
                                            SnarlRecord::set_tip_tip_connected(snarl_record_offset, &snarl_tree_records);
                                        }
#ifdef debug_distance_indexing
                                        assert(distance <= temp_snarl_record.max_distance);
                                        assert(SnarlRecord::get_distance(snarl_record_offset, &snarl_tree_records,
                                               node_rank1.first, node_rank1.second,
                                               node_rank2.first, node_rank2.second) ==  distance);
#endif
                                    }
                                ...
                                if (temp_snarl_record.distance_start_start != std::numeric_limits<size_t>::max()) {
                                    SnarlRecord::set_start_start_connected(snarl_record_offset, &snarl_tree_records);
                                }
                                if (temp_snarl_record.min_length != std::numeric_limits<size_t>::max()) {
                                    SnarlRecord::set_start_end_connected(snarl_record_offset, &snarl_tree_records);
                                }
                                if (temp_snarl_record.distance_end_end != std::numeric_limits<size_t>::max()) {
                                    SnarlRecord::set_end_end_connected(snarl_record_offset, &snarl_tree_records);
                                }

#ifdef debug_distance_indexing
                            cerr << "    The snarl record is at offset " << snarl_record_offset << endl;
                            cerr << "    This child snarl has " << SnarlRecord::get_node_count(snarl_record_offset, &snarl_tree_records) << " children: " << endl;
#endif
                                ...
                                if (!SnarlRecord::get_is_reversed_in_parent(snarl_record_offset, &snarl_tree_records)) {
                                    //If this snarl is oriented forward in the chain
                                    if (SnarlRecord::is_start_start_connected(snarl_record_offset, &snarl_tree_records)) {
                                        ChainRecord::set_start_start_connected(chain_record_offset, &snarl_tree_records);
                                    }
                                    if (SnarlRecord::is_end_end_connected(snarl_record_offset, &snarl_tree_records)) {
                                        ChainRecord::set_end_end_connected(chain_record_offset, &snarl_tree_records);
                                    }
                                    if (SnarlRecord::is_start_tip_connected(snarl_record_offset, &snarl_tree_records)) {
                                        ChainRecord::set_start_tip_connected(chain_record_offset, &snarl_tree_records);
                                    }
                                    if (SnarlRecord::is_end_tip_connected(snarl_record_offset, &snarl_tree_records)) {
                                        ChainRecord::set_end_tip_connected(chain_record_offset, &snarl_tree_records);
                                    }
                                } else {
                                ...
                                last_child_offset = make_pair(snarl_record_offset, true);
                                ...
                                size_t snarl_record_offset = ChainRecord::add_simple_snarl(chain_record_offset,
                                            &snarl_tree_records, temp_snarl_record.node_count, record_type, last_child_offset.first);

                                //Record how to find the new snarl record
                                record_to_offset.emplace(make_pair(temp_index_i, child_record_index), snarl_record_offset);

                                //Fill in snarl info
                                SimpleSnarlRecord::set_min_length(snarl_record_offset, &snarl_tree_records, temp_snarl_record.min_length);
                                SimpleSnarlRecord::set_max_length(snarl_record_offset, &snarl_tree_records, temp_snarl_record.max_length);
                                ...
                                for (size_t i = 0 ; i < temp_snarl_record.node_count ; i++ ) {
                                    ...
                                    if( child_index.first == TEMP_CHAIN) {
                                        ...
                                        SimpleSnarlRecord::add_child(snarl_record_offset, &snarl_tree_records, i+2, temp_node_record.node_id,  
...
#ifdef debug_distance_indexing
                            cerr << "    The simple snarl record is at offset " << snarl_record_offset << endl;
                            cerr << "    This child snarl has " << SnarlRecord::get_node_count(snarl_record_offset, &snarl_tree_records) << " children: " << endl;
#endif
                                last_child_offset = make_pair(snarl_record_offset, true);
                            }
                    ...
                    ChainRecord::set_last_child_offset(chain_record_offset, &snarl_tree_records,
                                     last_child_offset.first, last_child_offset.second, last_node_connected);
                    ...
                    size_t node_record_offset = NodeRecord::write_node_record(record_type, &snarl_tree_records, temp_node_record.node_id);
                    NodeRecord::set_node_id(node_record_offset, &snarl_tree_records, temp_node_record.node_id);
                    NodeRecord::set_node_length(node_record_offset, &snarl_tree_records, 
                                                temp_node_record.node_length);
                    NodeRecord::set_rank_in_parent(node_record_offset, &snarl_tree_records, 
                                                   temp_chain_record.rank_in_parent);
                    NodeRecord::set_parent_record_offset(node_record_offset, &snarl_tree_records, 
                                           record_to_offset[make_pair(temp_index_i, temp_chain_record.parent)]);
                    NodeRecord::set_distance_left_start(node_record_offset, &snarl_tree_records, 
                                            temp_chain_record.distance_left_start);
                    NodeRecord::set_distance_right_start(node_record_offset, &snarl_tree_records, 
                                            temp_chain_record.distance_right_start);
                    NodeRecord::set_distance_left_end(node_record_offset, &snarl_tree_records, 
                                            temp_chain_record.distance_left_end);
                    NodeRecord::set_distance_right_end(node_record_offset, &snarl_tree_records, 
                                             temp_chain_record.distance_right_end);

                    record_to_offset.emplace(make_pair(temp_index_i, current_record_index), node_record_offset);
                ...
                size_t snarl_record_offset = SnarlRecord::write_snarl_record (temp_snarl_record.node_count, &snarl_tree_records, record_type);

                //Fill in snarl info
                SnarlRecord::set_parent_record_offset(snarl_record_offset, &snarl_tree_records, 0);
                ...
                size_t node_record_offset = NodeRecord::write_node_record(record_type, &snarl_tree_records, temp_node_record.node_id);
                NodeRecord::set_node_id(node_record_offset, &snarl_tree_records, temp_node_record.node_id);
                NodeRecord::set_node_length(node_record_offset, &snarl_tree_records, temp_node_record.node_length);
                NodeRecord::set_rank_in_parent(node_record_offset, &snarl_tree_records, 
                                              temp_node_record.rank_in_parent);
                NodeRecord::set_parent_record_offset(node_record_offset, &snarl_tree_records, 
                                              record_to_offset[make_pair(temp_index_i, temp_node_record.parent)]);

                NodeRecord::set_distance_left_start(node_record_offset, &snarl_tree_records, 
                                            temp_node_record.distance_left_start);
                NodeRecord::set_distance_right_start(node_record_offset, &snarl_tree_records, 
                                            temp_node_record.distance_right_start);
                NodeRecord::set_distance_left_end(node_record_offset, &snarl_tree_records, 
                                            temp_node_record.distance_left_end);
                NodeRecord::set_distance_right_end(node_record_offset, &snarl_tree_records, 
                                            temp_node_record.distance_right_end);
        ...
        for (size_t component_num = 0 ; component_num < temp_index->components.size() ; component_num++){
            ...
            RootRecord::add_component(0, &snarl_tree_records, component_num,record_to_offset[make_pair(temp_index_i,component_index)]);

            size_t record_offset = record_to_offset[make_pair(temp_index_i, component_index)];

            if (SnarlTreeRecord::get_record_handle_type(record_offset, &snarl_tree_records) == CHAIN_HANDLE 
                    || SnarlTreeRecord::get_record_handle_type(record_offset, &snarl_tree_records) == ROOT_HANDLE) {
                SnarlTreeRecord::set_rank_in_parent(record_offset, &snarl_tree_records, component_num);
            }
            if (SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) != ROOT_SNARL 
                && SnarlTreeRecord::get_record_type(record_offset, &snarl_tree_records) != DISTANCED_ROOT_SNARL) {

                //If this isn't a root snarl
                handle_t start_out = graph->get_handle(
                         SnarlTreeRecord::get_start_id(record_offset, &snarl_tree_records), 
                         !SnarlTreeRecord::get_start_orientation(record_offset, &snarl_tree_records));

                handle_t end_out = graph->get_handle(
                         SnarlTreeRecord::get_end_id(record_offset, &snarl_tree_records), 
                         SnarlTreeRecord::get_end_orientation(record_offset, &snarl_tree_records));

                handle_t start_in = graph->get_handle(
                         SnarlTreeRecord::get_start_id(record_offset, &snarl_tree_records), 
                         SnarlTreeRecord::get_start_orientation(record_offset, &snarl_tree_records));

                handle_t end_in = graph->get_handle(
                         SnarlTreeRecord::get_end_id(record_offset, &snarl_tree_records), 
                         !SnarlTreeRecord::get_end_orientation(record_offset, &snarl_tree_records));
                ...
                graph->follow_edges(start_out, false, [&](const handle_t& h) {
                    if (h == start_in) {
                        SnarlTreeRecord::set_externally_start_start_connected(record_offset, &snarl_tree_records);
                    } else if (h == end_in) {
                        SnarlTreeRecord::set_externally_start_end_connected(record_offset, &snarl_tree_records);
                    }
                    return true;
                });
                graph->follow_edges(end_out, false, [&](const handle_t& h) {
                    if (h == end_in) {
                        SnarlTreeRecord::set_externally_end_end_connected(record_offset, &snarl_tree_records);
                    } else if (h == start_in) {
                        SnarlTreeRecord::set_externally_start_end_connected(record_offset, &snarl_tree_records);
                    }
                    return true;
    ...
    for (size_t temp_index_i = 0 ; temp_index_i < temporary_indexes.size() ; temp_index_i++) {
        ...
        for (size_t temp_snarl_i = 0 ; temp_snarl_i < temp_index->temp_snarl_records.size() ; temp_snarl_i ++) {
            ...
            if (!temp_snarl_record.is_trivial && !temp_snarl_record.is_simple) {
                //The snarl record has already been created, so just add new values to it
                size_t snarl_record_offset = record_to_offset[make_pair(temp_index_i, 
                                                                       make_pair(TEMP_SNARL, temp_snarl_i))];
                //Now add the children and tell the record where to find them
                SnarlRecord::set_child_record_pointer(snarl_record_offset, 
                        &snarl_tree_records, snarl_tree_records->size());
                for (pair<temp_record_t, size_t> child : temp_snarl_record.children) {
                    SnarlRecord::add_child(snarl_record_offset, &snarl_tree_records,
                                                       record_to_offset[make_pair(temp_index_i, child)]);
                    ...
                    if (child.first == TEMP_NODE) {
                        ...
                        if (temp_node_record.is_tip) {
                            if (temp_node_record.distance_left_start != std::numeric_limits<size_t>::max() ||
                                ...
                                SnarlRecord::set_start_tip_connected(snarl_record_offset, &snarl_tree_records);
                            }
                            if (temp_node_record.distance_left_end != std::numeric_limits<size_t>::max() ||
                                ...
                                SnarlRecord::set_end_tip_connected(snarl_record_offset, &snarl_tree_records);
                            }
                        }
                    } else {
